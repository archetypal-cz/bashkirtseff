...
```markdown
%% 01.01 %% # paragraph ID
%% [#HASHTAG1](../_glossary/HASHTAG1.md) [#HASHTAG2](../_glossary/HASHTAG2.md) %%
%% original French text mentioning hashtag1 and hashtag2%%
Czech translation text with footnotes[^01.01.1]
[^01.01.1]: Footnote content
%% YYYY-MM-DDThh:mm:ss RES: researcher comment %%
%% YYYY-MM-DDThh:mm:ss LAN: linguistic annotator comment %%
%% YYYY-MM-DDThh:mm:ss TR: translator comment %%

%% 01.02 %% # next paragraph after blank line

## original text in comment, etc., no blank lines until next paragraph %%
```
