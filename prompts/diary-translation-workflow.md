...
1. Researcher: Add context and hashtags to original
...
- Add opening research context comments
- Add hashtag links above relevant paragraphs
...
For each entry:
1. Researcher adds context/hashtags
...
1. **Researcher**: All entities have hashtag links
