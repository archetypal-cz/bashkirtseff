 ...
 * - This module uses content path codes: 'cz', 'fr', 'en', '_original'
...
// Path to content root (relative to frontend/)
 ...
 */
export function getCarnets(language: string = '_original'): CarnetInfo[] {
 ...
 */
export function getBooks(language: string = '_original'): CarnetInfo[] {
 ...
 */
export function getCarnetEntries(carnetId: string, language: string = '_original'): string[] {
  const carnetPath = language === '_original'
    ? path.join(CONTENT_ROOT, '_original', carnetId)
 ...
 */
export function getBookEntries(carnetId: string, language: string = '_original'): string[] {
 ...
 */
export function getEntry(carnetId: string, entryId: string, language: string = '_original'): DiaryEntry | null {
  const entryPath = language === '_original'
    ? path.join(CONTENT_ROOT, '_original', carnetId, `${entryId}.md`)
 ...
 */
export async function getCarnetSummary(carnet: string, language: string = '_original'): Promise<CarnetSummary> {
 ...
 */
export function getEntryNavigation(carnetId: string, entryDate: string, language: string = '_original'): {
  prev: string | null;
  next: string | null;
} {
...
export function hasTranslation(carnetId: string, entryDate: string, language: string): boolean {
  if (language === '_original') return true;
 ...
 */
export function hasCarnet000Content(language: string = '_original'): boolean {
 ...
 */
export function hasBook00Content(language: string = '_original'): boolean {
 ...
 */
export function hasPrefaceContent(language: string = '_original'): boolean {
  return hasCarnet000Content(language);
}
 ...
 */
export function getCarnet000Merged(language: string = '_original'): DiaryEntry | null {
  const entries = getCarnetEntries('000', language);
 ...
 */
export function getBook00Merged(language: string = '_original'): DiaryEntry | null {
 ...
 */
export function getPrefaceMerged(language: string = '_original'): DiaryEntry | null {
  return getCarnet000Merged(language);
}
 ...
 */
export function getYears(language: string = '_original'): YearInfo[] {
 ...
 */
export function getCarnetsByYear(year: number, language: string = '_original'): CarnetInfo[] {
  const carnets = getCarnets(language);
 ...
 */
export function getEntriesByYear(year: number, language: string = '_original'): Array<{ carnet: string; entryId: string; date: Date }> {
  const carnets = getCarnets(language);
 ...
 */
export function isCarnetCrossYear(carnetId: string, language: string = '_original'): { crossYear: boolean; years: number[] } {
  const entries = getCarnetEntries(carnetId, language);
 ...
 */
export function getYearInfo(year: number, language: string = '_original'): YearInfo | null {
 ...
 */
function getGlossaryPath(language: string = '_original'): string {
  if (language === '_original' || language === 'original') {
    return path.join(CONTENT_ROOT, '_original', '_glossary');
  }
 ...
 */
export function getGlossaryEntries(language: string = '_original'): GlossaryEntry[] {
 ...
 */
export function getGlossaryEntry(id: string, language: string = '_original'): GlossaryEntry | null {
  const glossaryPath = getGlossaryPath(language);
  const files = findGlossaryFiles(glossaryPath);
 ...
 */
export function getGlossaryByLetter(language: string = '_original'): Map<string, GlossaryEntry[]> {
 ...
 */
export function searchGlossary(query: string, language: string = '_original'): GlossaryEntry[] {
  const entries = getGlossaryEntries(language);
 ...
 */
export function getEntryPreview(carnetId: string, entryId: string, language: string = '_original', maxLength: number = 150): string | null {
 ...
 *
 * @param language - Target language for previews (defaults to '_original')
 * @returns Map of "MM-DD" -> array of entries for that day
 */
export function buildThisDayData(language: string = '_original'): ThisDayData {
  ...
  for (const carnet of carnets) {
    ...
    for (const entryId of entries) {
      ...
      const previewLang = translationExists ? language : '_original';
 ...
 */
export function getThisDayEntries(monthDay: string, language: string = '_original'): ThisDayEntry[] {
