...
3. **File-Based State**:
   ...
   - Workflow state in `src/_original/_workflow/`
...
### Workflow State
- `src/_original/_workflow/decision_log.md` - All agent decisions
- `src/_original/_workflow/metrics/` - Quality reports per book
- `src/_original/{book}/_workflow/` - Per-entry state files
...
```bash
# Pick an entry
ls src/_original/15/ | head -5

# Run research phase
just research 1882-05-01 15

# Check output
cat src/_original/_workflow/research_1882-05-01.json
...
1. Check `src/_original/_workflow/decision_log.md`
