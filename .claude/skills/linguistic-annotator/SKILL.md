...
```bash
just find-missing "LAN:" src/_original/Book_03    # Entries without LAN annotations
just find-missing "RSR:" src/_original/Book_03    # Entries without RSR (need research first)
```
