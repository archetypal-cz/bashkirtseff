...
**Glossary entry format** (save to `src/_original/_glossary/CAPITAL_ASCII_NAME.md`):
...
```bash
just find-missing "RSR:" src/_original/015    # Find entries without RSR comments
just find-missing "LAN:" src/_original/015    # Find entries without LAN annotations
just find-missing "#French" src/_original/015 # Find entries without language tags
```
...
6. For entries not in src/_original, wrap original text in comments
