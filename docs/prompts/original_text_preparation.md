...
1. Work with already prepared markdown daily entry files in `/src/_original/XX/` directories
...
%% 01.07 %%
%% [#UN_BALLO_IN_MASCHERA](../_glossary/UN_BALLO_IN_MASCHERA.md) %%
%% Ce soir, à l'Opéra, "Un ballo in maschera". Beaucoup de monde, mais moi, je suis triste. %%

%%2 025-04-05T15:45:00 RSR: End line in original file: 127 %%
```
