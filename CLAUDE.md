...
3. **Report it** in [GitHub Discussions](https://github.com/archetypal-cz/bashkirtseff/discussions) if you can't fix it yourself
...
Each entry file (e.g., `src/_original/001/1873-01-11.md`) contains:
...
- **Style Guide**: `/prompts/Style.md`
- **Infrastructure**: `/docs/INFRASTRUCTURE.md` - Progress tracking & collaboration
- **Content Guide**: `/src/CLAUDE.md` - Diary content structure
- **Frontend Guide**: `/frontend/CLAUDE.md`
- **Shared Package Guide**: `/shared/CLAUDE.md` + `/shared/README.md`
- **Role Details**: `/.claude/skills/*/SKILL.md`
- **Glossary Skill**: `/.claude/skills/glossary/SKILL.md`
- **Glossary Entries**: `/src/_original/_glossary/`
