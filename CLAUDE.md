...
The project includes a `justfile` for simplified task management:
...
just dev                 # Quick Czech build for development

# Viewing compiled books
...
just verify              # Verify entry consistency
...
just test                # Run tests
just clean               # Clean compiled files
```

### Poetry Environment Setup (if not using Just)
```bash
