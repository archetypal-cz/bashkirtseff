...
%% 2026-06-11T10:00:00 LAN: TRAP: FALSE-FRIEND (source) — "le pere Gans etait tres INTRIGUE de voir mon bas" = mystified / intrigued / had his curiosity piqued (he could not make out why she was knitting), the harmless puzzlement sense — NEVER "to scheme/plot". Contrast the genuine-scheme sense at 06-28 ("mener une intrigue") and 07-02 ("victime de quelque intrigue"). Judge per occurrence. %%
%% 2026-08-14T00:10:00 ED: Dedup: manuscript page-overlap extraction artifact — this paragraph is the tail/head overlap of the adjacent page and appeared verbatim in the neighboring cluster; deduplicated to match cz/en/fr rendering. %%
...
%% 081.0469 %%
%% [#Kernberger](../_glossary/culture/literature/KATHERINE_KERNBERGER.md) %%
%% 2026-09-26T12:00:00 RSR: Removed a duplicate copy of the preceding paragraph's text that opened this paragraph (manuscript page overlap in the transcription); tome12.docx has it once, and the translations place it in 081.0468. %%
