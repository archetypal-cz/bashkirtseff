...
%% 2026-09-26T00:00:00 RSR: RULING on "sa voiture" (also at 003.0103, 003.0147): the Duke of Hamilton's carriage, not Gioia's. Here Marie has just described Gioia's landau ("un landau avec deux messieurs la suivant") in the previous sentence, then marks a deliberate contrast — "*sa* voiture" is italicized in the source, singling it out from the landau just mentioned — and she recognizes it by "le bruit bien connu" (the well-known noise), tracking it toward the gare where she hopes the Duke is arriving. The identical reaction (hearing/half-hearing "le bruit de sa voiture" and being overcome) recurs at 003.0103 and 003.0147, each time embedded in a paragraph fixated on the Duke, never on Gioia. %%
