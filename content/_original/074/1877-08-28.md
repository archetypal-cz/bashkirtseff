...
%% [#Bachmakoff](../_glossary/people/mentioned/BACHMAKOFF.md) %%
%% [#Batourine](../_glossary/people/mentioned/BATOURINE.md) %%
...
%% 2026-06-11T10:02:00 LAN: TRAP: COLLISION — "Alexandre" here (and in the next paragraph, "l'explication d'Alexandre") = Larderei (code-name), per RSR — NOT the uncle nor the Tsar, despite the [#Alexandre] tag. (Earlier in this same entry, 074.0108 "Batourine se nomme Alexandre" is a different bearer, disambiguated there by the explicit surname.) %%
