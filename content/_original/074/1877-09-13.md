...
%% 2026-06-11T10:10:00 LAN: TRAP: COLLISION — "Alexandre" here (the sickly, beloved figure in the dream) = Larderei (code-name), per RSR — listed alongside Cassagnac and the Italians. NOT the uncle nor the Tsar. (Same referent at 074.0336 later in this entry, "Alexandre n'a pas besoin de devenir amoureux", a callback to the Plevna pairing.) %%
...
%% [#M_Marx](../_glossary/people/mentioned/M_MARX.md) %%
