...
---
%% 074.0256 %%
%% 2026-06-11T10:10:00 LAN: TRAP: PRESERVE-AS-WRITTEN — the title reads "Dimache" (Marie's misspelling of "Dimanche", missing the 'n'); confirmed against the source tome (the adjacent 09-02 and 09-23 Sundays are correctly "Dimanche"). Keep the misspelling as written; do NOT silently normalize to "Dimanche". %%
