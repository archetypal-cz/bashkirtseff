...
dates:
  primary: "Mercredi, 6 octobre 1875"
  merged: []

entities:
  people: [Audiffret, Audiffret_Leon, Sapogenikoff_Nina, Sapogenikoff_Olga, Saetone, Gioia, Andriot]
  places: [Nice, Promenade_des_Anglais, Bois_de_Boulogne]
...
%% 2026-02-09T21:00:12 RSR: Marie's satirical poem "Prediction de Cassandre" is one of the remarkable literary productions of this carnet. Addressed to Audiffret's father ("Ton fils"), it prophesies the young man's moral ruin in 26 stanzas (some crossed out and renumbered). Each stanza ends with the darkly comic refrain "et pourrira, et pourrira!" (and will rot, and will rot!). The poem traces a trajectory from Parisian debauchery (Bignon, Mabille, Moulin Rouge) through financial ruin and imprisonment to a final return to the family trade of cloth-measuring. It reveals Marie's literary talent, her rage, and her deep knowledge of Parisian demi-monde geography — remarkable for a 16-year-old who claims to be sheltered. %%
