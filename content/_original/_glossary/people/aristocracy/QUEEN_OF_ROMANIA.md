...
%% GLO_QUEEN_OF_ROMANIA.0001 %%
## Basic Information

%% GLO_QUEEN_OF_ROMANIA.0002 %%
...
%% GLO_QUEEN_OF_ROMANIA.0003 %%
## Connection to Marie's Diary

%% GLO_QUEEN_OF_ROMANIA.0004 %%
...
%% GLO_QUEEN_OF_ROMANIA.0005 %%
## Literary Career

%% GLO_QUEEN_OF_ROMANIA.0006 %%
- Published poetry, prose, and drama in German, Romanian, and French
- Best known work: *Les Pensees d'une Reine* (Thoughts of a Queen)
- Member of literary salons across Europe
- Corresponded with major cultural figures of the era

%% GLO_QUEEN_OF_ROMANIA.0007 %%
%% 2026-02-10T12:15:00 RSR: Enriched from stub. Queen Elisabeth of Romania (Carmen Sylva) was a writer-queen who would have interested Marie as a model of female achievement combining social position and artistic talent. %%
