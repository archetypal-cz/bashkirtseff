---
id: BETE
name: Princess Nathalie Galitzine
aliases:
  - Bête
  - Bete
  - la Bête
...
%% GLO_BETE.0002 %%
**Princess Nathalie (Nadine) Galitzine** (nee unknown; Russian: Голицына), a Russian princess of the Galitzin/Golitsyn family. Marie gives her the nickname "Bête" (French: "beast" or "stupid one"), one of her characteristically unflattering yet affectionate monikers. Marie herself explains the nickname: "Bête que j'ai injustement nommée ainsi; mais Bête est plus court que princesse et je le préfère" (015.0044, Jan 5, 1874) -- she chose "Bête" simply because it was shorter than "princesse." In 1876, looking back from Rome, she refers to her as "ma chère princesse que j'avais surnommée si bêtement Bête" (055.0935, Mar 22, 1876) -- "my dear princess whom I had nicknamed so stupidly Bête."
...
%% GLO_BETE.0006 %%
She had at least one daughter, mentioned in the September 29, 1873 name day entry (010.0124): "C'est la fête de ma tante, de Bête, de sa fille et de la petite Véra Anitchkoff." A "petite blonde Nathalie Galitzine" appears in a later entry (050.0730, Dec 16, 1875), described as having died recently in Russia "dans les bras" of her lover Simiane -- this may refer to the daughter rather than the princess herself, since the princess is still alive in 1876.
...
%% GLO_BETE.0009 %%
Despite the unflattering nickname and occasional exasperation, Princess Galitzine was one of Marie's closest companions during the Nice period (1873-1874). Their relationship was multifaceted:
...
%% GLO_BETE.0016 %%
- **Plainspoken to a fault**: Touches on topics Marie considers sacred; announces Hamilton news at dinner with no tact
...
- **Financially dependent**: The princess pays for ice cream when she receives money from her belle-mère (mother-in-law), but Marie has paid for her for two months prior (008.0302, Aug 31, 1873)
...
- **Carnet 008** (Aug 1873): Still "la princesse" in the text; note that "Bête que je suis" in 008.0300 is Marie calling herself stupid, not the nickname
...
- **Carnet 026** (Nov 1874): Quoted by name -- "princesse Nadine Galitzine"
- **Carnet 031** (Apr 1875): Nostalgic longing -- "mon désir insensé de voir la princesse Galitzine"
- **Carnet 050** (Dec 1875): "la petite blonde Nathalie Galitzine" -- her death or her daughter's death reported
- **Carnet 055** (Mar 1876): Final reference from Rome -- "ma chère princesse que j'avais surnommée si bêtement Bête"
- **Carnet 064** (Aug 1876): Reunion in Russia -- Marie visits her in villegiatura near St. Petersburg

%% GLO_BETE.0019 %%
## Key Paragraph References

%% GLO_BETE.0020 %%
- 007 (Jul 13, 1873): First appearance; Marie at ease with her, marriage advice, "cette canaille que son mari"
- 007 (Jul 14, 1873): "La princesse Galitzine est toujours chez nous" -- almost daily presence
...
- 008.0302 (Aug 31, 1873): "la princesse me paye une glace" -- after Marie paid for her two months
...
- 010.0124 (Sep 29, 1873): Name day shared with ma tante, her daughter, and Vera Anitchkoff
...
- 014 (Dec 11, 1873): "la Bête, l'insipide Cunegunda" -- Voltaire allusion at peak frustration
- 015 (Jan 5, 1874): Marie explains the nickname: "Bête est plus court que princesse"
- 015 (Jan 25, 1874): Abrial's warning -- "un ennemi" who resents the family's generosity
- 016 (Feb 1, 1874): "Bête dit qu'elle le dit au nom de Mme Bashkirtseff" -- acts as family spokesperson to dismiss Hitchcock
- 017 (Mar 2, 1874): "Bête et ma tante" -- late-night scene, Marie ranting about visitors
- 019 (May 6, 1874): "Moi, Dina et Bête, allons à l'église" -- "la princesse me présenta à Mme Angel"
...
- 050.0730 (Dec 16, 1875): "la petite blonde Nathalie Galitzine" -- death in Russia
- 055.0935 (Mar 22, 1876): "ma chère princesse que j'avais surnommée si bêtement Bête"
...
%% GLO_BETE.0022 %%
Several LAN annotations incorrectly identify "Bête" as "Princess Hitchcock" or conflate her with Miss Hitchcock, the English governess. Miss Hitchcock is a completely separate person -- a "thin, brown, dry Englishwoman" (011, Nov 1, 1873) hired as Marie's English tutor, whom Marie despises and eventually has dismissed. The LAN comment in 014/1873-12-11.md ("Marie's contemptuous name for Cunegunda/Hitchcock") and in 014/1873-12-21.md ("nickname for Princess Hitchcock") are both errors. "Bête" and "Cunegunda" refer exclusively to Princess Nathalie Galitzine.

%% GLO_BETE.0023 %%
## Related Entries

%% GLO_BETE.0024 %%
- [#Ma_tante](../family/MA_TANTE.md) -- Shares name day; both part of the core household
- [#Dina](../core/DINA.md) -- The other regular companion in the Hamilton discussions
- [#Duke_of_Hamilton](../core/DUKE_OF_HAMILTON.md) -- Central topic of conversation between Marie and Bête
