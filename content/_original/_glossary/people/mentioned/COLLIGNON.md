...
aliases:
  - Mlle Collignon
  - Collignon
  - Mademoiselle Collignon
  - la Collignon
  - cette Collignon
  - cette canaille Collignon
  - canaille Collignon
  - cette canaille
  - cette pauvre Collignon
  - la pauvre Collignon
  - pauvre Collignon
  - cette chère
...
**Diary Coverage**: Carnet 001 (Jan 1873) through carnet 103 (Feb 1884) — ~215 diary files
**Type**: Person — Governess, later family friend

## Overview

Mademoiselle Collignon is one of the most enduring figures in Marie's life, present across virtually the entire diary from the first carnet to the last. She enters as Marie's French governess and English teacher in Nice (hired before the diary begins, from at least January 12, 1872), is dramatically dismissed in May 1873 after escalating conflicts, yet returns as a close family friend and confidante who remains in Marie's orbit for the rest of her life. She dies of tuberculosis in late October 1881, approximately eight years after Dr Walitsky first diagnosed her terminal condition.
...
- [#Walitsky](../recurring/WALITSKY.md) — Family doctor who diagnosed Collignon's tuberculosis in 1873
- [#English](../../culture/languages/ENGLISH.md) — Marie's English education, in which Collignon was the first teacher
- [#Death](../../culture/themes/DEATH.md) — Collignon's death listed among deaths of acquaintances
