...
- **Pieter Boreel** (c. 1584-1668), Dutch Ambassador to France (1650-1668)
- **Jacob Boreel** (1630-1697), Burgomaster of Amsterdam and diplomat
- **Willem Boreel** (1591-1668), diplomat and scholar
- Multiple members of the Dutch States-General and colonial administrators
See: [Boreel family on Wikipedia](https://en.wikipedia.org/wiki/Boreel_family)

%% GLO_BOREEL.0004 %%
The family held the title of Baron, which was created in the Dutch nobility system. By the 19th century, various branches of the family had intermarried with other Dutch and European aristocratic families. Marie confirms through Gericke in 1874 that Boreel was "d'excellente maison" -- of excellent family (021.0067, entry 1874-07-09).

%% GLO_BOREEL.0005 %%
## Nationality Confusion

%% GLO_BOREEL.0006 %%
Marie records a comical series of conflicting identifications of Boreel's nationality (002.0121-0125, entry 1873-02-27):
...
- Marie repeatedly criticizes his gait as "ignoble" and "vilaine demarche" -- ungainly walk lacking grace and nobility (001.0016, 040.0094)
...
- **Villa and residence**: The family occupied or rented a villa on the Promenade des Anglais area; Marie mentions "les villas 57, Boreel, Canepa" in her panoramic view from Villa Acqua Viva (006, entry 1873-06-19). They also used **La Corinthienne**, a villa Marie associates with Boreel family gatherings and dinners (004.0199, entry 1873-04-29; 010.0087, entry 1873-09-26).
- **Mme Boreel** (his mother): Seen at her window at the start of the 1873-74 season (010.0087, entry 1873-09-27). Marie notes her arriving with a young blonde woman she speculates might be Boreel's wife (010.0153, entry 1873-10-01). Last seen departing Nice with Boreel in May 1876 (059, entry 1876-05-07).
- **Baronne de Palland-Nermen** (nee Boreel): Boreel's sister, married to Baron de Palland-Nermen. She and her husband appear in Nice society and observe Marie with evident curiosity (002.0196, entry 1873-03-07; 004.0325, entry 1873-05-10).
- **A dog**: The family dog's collar read "M. Robert Boreel" and would follow Marie's family in the street (004.0200, entry 1873-04-27).
...
- Attendance at balls at the Cercle Massena, where he directed the cotillion (002.0106, entry 1873-02-24)
- Appeared in carnival costume as a "bandit" (002.0062-0065, entry 1873-02-23) and rode in the carnival cavalcade
- Late-night suppers with Prince Gagarine, Markoff, and Gouchkevitch (002.0116, entry 1873-02-27)
- Gambling at Monaco -- Marie morally disapproves but finds it adds to his charm (002.0130, entry 1873-02-27)
...
- Appeared at Nice in December 1873 "tout en bleu avec son caniche bien rase" -- all in blue with his well-clipped poodle, on a dog-cart (014.0262, entry 1873-12-27)
...
%% GLO_BOREEL.0016 %%
Before starting her written diary, Marie tracked her Boreel sightings using a coded notation system on earlier pages: "Un O indiquait que j'avais vu Boreel, autant de O autant de fois je l'avais vu. Une croix X, que je l'avais regarde et plusieurs que lui m'avait regardee" -- an O indicated she had seen Boreel, as many Os as times seen; an X that she had looked at him, and multiple Xs that he had looked at her (009.0045, entry 1873-09-06). This predates the diary proper and shows her systematic, almost scientific approach to romance even before she began writing.
...
- She compares them explicitly: "Si quand je vois Boreel j'ai de la joie, c'est un rayon de soleil qui penetre dans mon coeur quand je vois le duc" -- if seeing Boreel brings joy, seeing the Duke is a sunbeam penetrating her heart (001.0068, entry 1873-02-01)
- She strategically uses her visible blushing for Boreel to disguise her feelings for the Duke (002.0056, entry 1873-02-17)
- She throws flowers to him during carnival, then agonizes over whether he interpreted it as romantic interest (002.0065, entry 1873-02-23)
- She learns his true identity (not Baron Finot) and is disappointed (002.0116, entry 1873-02-27)
...
By March 1873, Marie declares Boreel "indifferent" to her (003.0024, entry 1873-03-25) and "ugly, with a tired face" (003.0028, entry 1873-03-27). She retrospectively refers to her Boreel period as "childish" and the emotion as the natural first love that could have passed without trace, unlike her feelings for Hamilton (002.0198, entry 1873-03-05).
...
%% GLO_BOREEL.0026 %%
Boreel appears across at least 28 carnets spanning 1873-1880:
- **Carnets 001-011** (Jan-Oct 1873): Primary period of active romantic interest
- **Carnet 014** (Dec 1873): Seasonal return to Nice, mentioned in society panorama
- **Carnets 016-017** (Jan-Mar 1874): Absence noted, involuntary blushing
- **Carnets 019-023** (May-Aug 1874): Retrospective references, seen in Spa
- **Carnet 029** (Jan 1875): Listed in chronological list of infatuations: "Boreel 1872-73"
- **Carnet 040** (Aug 1875): Major retrospective account of entire Boreel-to-Hamilton arc
- **Carnets 050-051** (Dec 1875-Jan 1876): Seen again in Nice, physically changed
- **Carnet 059** (May 1876): Last physical sighting, departing Nice with his mother
- **Carnet 068** (Jan 1877): Categorized as "childhood" attachment
- **Carnet 090** (Oct 1880): Final mention, embarrassment at old diary pages
...
%% 2026-02-11T14:05:00 RSR: Per Kernberger (2013), Boreel was "young man Marie has a crush on before her interest in Hamilton." This confirms the chronology: Boreel preceded Hamilton as the object of Marie's romantic interest. %%
%% 2026-05-25T12:00:00 RSR: Expanded to Comprehensive. Added historical identification of the Boreel family as Dutch patrician/aristocratic family. Added paragraph IDs throughout. Documented the "Robert Boreel" name from the dog collar, the Palland-Nermen sister, the Prater resemblance origin story, the coded notation system, and the full arc across all 28 carnets (1873-1880). Age estimated at 24-25 in winter 1871-72 per Marie's 1875 retrospective. Aliases expanded to include "le gros Boreel," "le Prussien," and the Baron Finot misidentification. %%
