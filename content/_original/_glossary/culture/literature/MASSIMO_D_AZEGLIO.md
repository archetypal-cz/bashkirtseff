...
%% GLO_MASSIMO_D_AZEGLIO.0001 %%
## Overview

%% GLO_MASSIMO_D_AZEGLIO.0002 %%
...
%% GLO_MASSIMO_D_AZEGLIO.0003 %%
## Relevance to Marie

%% GLO_MASSIMO_D_AZEGLIO.0004 %%
...
%% GLO_MASSIMO_D_AZEGLIO.0005 %%
## Historical Context

%% GLO_MASSIMO_D_AZEGLIO.0006 %%
...
%% GLO_MASSIMO_D_AZEGLIO.0007 %%
## Works Referenced

%% GLO_MASSIMO_D_AZEGLIO.0008 %%
- *Niccolò de' Lapi, ovvero I Palleschi e i Piagnoni* (1841) — Historical novel about the siege of Florence in 1530

%% GLO_MASSIMO_D_AZEGLIO.0009 %%
## References in Diary

%% GLO_MASSIMO_D_AZEGLIO.0010 %%
- 1875-10-01 (carnet 045) — Sabatini reads *Niccolò de' Lapi* to Marie

%% 2026-02-10T20:00:00 RSR: Enriched from stub. Italian nationalist novelist read aloud to Marie. %%
