...
%% GLO_VOITURE.0007 %%
Marie sometimes specifies:
- **"voiture fermée"** — closed carriage (privacy, discretion, or bad weather)
- **"voiture découverte"** — open carriage (display, fine weather)
- **"sa voiture"** — his/her own carriage (ownership = status)
- **"en voiture"** — riding in a carriage (vs. on horseback or on foot)
- **"descendre de voiture"** — getting out (to walk, to approach someone)

%% GLO_VOITURE.0008 %%
## References in Diary

%% GLO_VOITURE.0009 %%
- Hundreds of references throughout the diary (1873-1884)
- The single most common transport term
- Used both for literal travel and as setting for social encounters

%% 2026-02-10T20:00:00 RSR: Created entry. General carriage term, ubiquitous in the diary. %%
