...
%% GLO_PHAETON.0004 %%
Key features:
- Light, open body with high seat
- Four wheels, front pair typically smaller
- Could be driven by the owner (no coachman required)
- Seating for one or two passengers
- Various subtypes: high phaéton, spider phaéton, mail phaéton
- Associated with speed and sportiness
...
%% GLO_PHAETON.0010 %%
- **Tilbury** — similar light owner-driven carriage
- **Fiacre** — hired cab
- **Calèche** — more formal open carriage

%% 2026-02-10T20:00:00 RSR: Created entry. Light carriage used by Marie as social status indicator. %%
