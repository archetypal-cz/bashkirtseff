...
%% GLO_CARNAVAL.0004 %%
The Nice carnival (Carnaval de Nice) was one of the largest in Europe, featuring:
- **Corso**: Procession of decorated carriages along the Promenade des Anglais
- **Bataille de confettis**: Confetti battles between carriages and spectators
- **Bataille de fleurs**: Flower battles (throwing bouquets)
- **Masking**: Wearing dominos (hooded cloaks) and masks
- **Decorated carriages**: Marie's family decorates a break in mauve sateen (1882)
- **Tribunes**: Grandstand seating for spectators
...
%% GLO_CARNAVAL.0010 %%
- **Domino** — a hooded masquerade cloak
- **Confetti** — originally plaster pellets, later paper
- **Corso** — the carnival procession route
- **Masque** — mask worn during carnival
- **Mardi Gras** — final day of carnival, Shrove Tuesday

%% GLO_CARNAVAL.0011 %%
## References in Diary

%% GLO_CARNAVAL.0012 %%
- 1876-02-22 (carnet 054): Rome carnival on the Corso
- 1882-02-16 (carnet 094): "Premier jour de Carnaval" — Nice carnival
- 1882-02-18 (carnet 094): "Grande bataille de confettis"

%% 2026-02-10T20:00:00 RSR: Created entry. Carnival is a recurring highlight in Nice and Rome entries. %%
