...
%% GLO_ACADEMIE_JULIAN.0001 %%
## Overview

%% GLO_ACADEMIE_JULIAN.0002 %%
...
%% GLO_ACADEMIE_JULIAN.0003 %%
## Organization

%% GLO_ACADEMIE_JULIAN.0004 %%
...
%% GLO_ACADEMIE_JULIAN.0006 %%
## Relevance to Marie

%% GLO_ACADEMIE_JULIAN.0007 %%
...
%% GLO_ACADEMIE_JULIAN.0010 %%
## Historical Significance

%% GLO_ACADEMIE_JULIAN.0011 %%
...
%% GLO_ACADEMIE_JULIAN.0012 %%
## References in Diary

%% GLO_ACADEMIE_JULIAN.0013 %%
- First mentioned: October 1877 (carnet ~073, enrollment)
- Appears in nearly every diary entry from 1877-1884
- Over 225 references across the diary

%% 2026-02-10T20:00:00 RSR: Enriched from stub. Académie Julian is the single most frequently referenced institution in the diary, central to Marie's identity as an artist. %%
