...
%% GLO_EMOTIONS.0006 %%
Marie uses a rich, precise vocabulary for her states:
- **"tristesse"** — sadness, melancholy
- **"ennui"** — boredom, existential weariness (stronger than English "boredom")
- **"rage" / "fureur"** — anger, fury
- **"désespoir"** — despair
- **"bonheur"** — happiness
- **"angoisse"** — anguish, anxiety
- **"honte"** — shame
- **"dégoût"** — disgust, revulsion
- **"mélancolie"** — melancholy (the Romantic, lingering kind)
- **"enthousiasme"** — enthusiasm, excitement

%% GLO_EMOTIONS.0007 %%
## Patterns

%% GLO_EMOTIONS.0008 %%
- Marie often opens entries with emotional weather reports: "Je suis triste", "Je suis gaie", "Je suis furieuse"
- She tracks emotional fluctuations within a single day
- Emotions are linked to social events, artistic progress, health, and romantic situation
- She distrusts emotions that seem false or performed, even in herself
