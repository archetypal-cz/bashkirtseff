...
%% 2026-06-11T10:08:00 LAN: TRAP: COLLISION — the "Boyd" name covers several people: "Mme Boyd"/"Madame Boyd" = the mother; "Berthe" (= Mlle Boyd) = the daughter Marie befriends; "Mme Yorke" = the married elder sister (née Boyd). "les Boyd" = the family/sisters collectively. Track which is meant; do not collapse them. %%
...
%% 2026-06-11T10:03:00 LAN: TRAP: FALSE-FRIEND (source) — "intriguer qqn" in this masked-ball arc = to mystify/pique curiosity, NOT to scheme/plot. The scheming sense also occurs elsewhere in the carnet — judge per occurrence. %%
...
Je lui ai dit en suédois que sa robe était très bien. Mme de Daillens ajouta en français qu'elle, la femme, était bien malade et ferait bien d'aller se coucher.[^1]
