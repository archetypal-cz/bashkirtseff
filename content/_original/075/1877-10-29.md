...
%% 2026-06-11T10:07:00 LAN: TRAP: EMBEDDED-DOCUMENT — paragraphs 075.0456–0458 ("Mademoiselle, ... Votre tout dévoué Marcuard.") reproduce a verbatim note/letter from the commandeur Marcuard. Render in a formal letter register, distinct from Marie's diary narration; preserve any source quirks. %%
%% 2026-06-11T10:08:00 LAN: TRAP: PRESERVE-AS-WRITTEN — "[Mots noircis : ...]" is an editorial bracket marking struck-through/blacked-out manuscript text, not Marie's prose; do not translate the bracket's content as if it were her own narration. %%
Mademoiselle,
...
%% 2026-06-11T10:09:00 LAN: TRAP: COLLISION — "votre Alexandre" here = Larderei. This paragraph tags BOTH [#Alexandre] and [#Larderei]: they are the SAME man (Marie's code-name + real surname), NOT two people. The next paragraph (075.0471) confirms it ("avec Larderei"). Do not render as separate individuals. %%
...
%% 075.0473 %%
%% [#Skating](../_glossary/places/venues/SKATING.md) [#Mirafiore](../_glossary/people/mentioned/MIRAFIORE.md) %%
%% [#Love](../_glossary/culture/themes/LOVE.md) %%
%% [#Alexandre](../_glossary/people/core/ALEXANDRE.md) %%
%% [#Marriage](../_glossary/culture/themes/MARRIAGE.md) %%
%% 2026-06-11T10:10:00 LAN: TRAP: COLLISION — "Alexandre" here = Larderei: Marcuard reports the countess hoped for "un beau mariage pour Alexandre" (i.e. marrying Marie to Larderei). "sa mère / la comtesse" = Larderei's mother. Not the uncle despite the auto-tag. %%
...
%% 075.0488 %%
%% [#Alexandre](../_glossary/people/core/ALEXANDRE.md) %%
%% 2026-06-11T10:11:00 LAN: TRAP: COLLISION — "Alexandre" here = Larderei (the man being discussed throughout this cross-examination). Not the uncle despite the auto-tag. %%
...
%% [#Alexandre](../_glossary/people/core/ALEXANDRE.md) %%
%% [#Suisse](../_glossary/places/countries/SUISSE.md) %%
%% 2026-06-11T10:12:00 LAN: TRAP: COLLISION — "Alexandre" here = Larderei: same man named outright at the end of the sentence ("la fatuité de Larderei"). The two tags [#Alexandre] and [#Larderei] denote ONE person. %%
