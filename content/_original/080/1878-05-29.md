...
%% 080.0378 %%
%% [#Theater_theme](../_glossary/culture/themes/THEATER_THEME.md) %%
%% 2026-06-11T10:00:00 LAN: TRAP: REFERENT-SHIFT — in this scene and from this arc on, "Popaul" and bare "Paul" = Paul de Cassagnac (first-name/nickname), NOT Marie's brother Paul. Disambiguate by context throughout. %%
...
%% 080.0382 %%
%% 2026-06-11T10:01:00 LAN: TRAP: FALSE-FRIEND (source) — "déjà intrigué" here = already piqued/made curious (interest aroused), NOT "intrigued against / plotting". Same false-friend recurs in this arc — judge per occurrence. %%
...
%% 2026-06-11T10:03:00 LAN: TRAP: NICKNAME — "beaux yeux de terre-neuve" = Newfoundland-dog epithet for Cassagnac (gentle-giant image); keep this dog-image consistent across the arc, not a literal place reference. %%
...
%% 2026-06-11T10:02:00 LAN: TRAP: ROLE-PLAY — "mon frère" is the flirtation's brother/sister role-play with Cassagnac, NOT Marie's real sibling. Do not read as literal kinship. %%
