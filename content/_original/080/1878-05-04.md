...
%% 2026-06-11T10:11:00 LAN: TRAP: PRESERVE-AS-WRITTEN — keep Marie's Latin exactly as written ("Gloriae Cupididas"); do NOT silently correct to "Gloriae Cupiditas". Footnote the correct form and meaning ("desire/lust for glory") in the target language instead. %%
Gloriae Cupididas[^1]
...
%% 080.0016 %%
%% [#Love](../_glossary/culture/themes/LOVE.md) %%
%% 2026-06-11T10:12:00 LAN: TRAP: FALSE-FRIEND (source) — "tripoteur" as self-description (here and again at 080.0017) = a meddler / over-analyzer / restless fiddler (affectionate-self-critical: someone who can't leave things alone, picks everything apart by excess of finesse), NOT political scheming/graft. Distinct from genuine "tripotages politiques" Marie uses elsewhere for actual intrigue. %%
