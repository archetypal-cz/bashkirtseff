...
%% [#Paris](../_glossary/places/cities/PARIS.md) [#Dina](../_glossary/people/core/DINA.md) [#Berthe](../_glossary/people/recurring/BERTHE.md) [#Yorke](../_glossary/people/mentioned/YORKE.md) [#Mme_de_Daillens](../_glossary/people/aristocracy/MME_DE_DAILLENS.md) [#Spanish](../_glossary/culture/languages/SPANISH.md) [#French](../_glossary/culture/languages/FRENCH.md) %%
...
%% 2026-06-11T14:20:00 LAN: TRAP: COLLISION — "Georges" here = Berthe Boyd, a FEMALE friend (family/masked-game nickname; "Georges Berthe" = Georges, i.e. Berthe). Elsewhere in this carnet bare "Georges" = Georges Babanine, Marie's stepfather (male relative). Do not conflate the two referents; judge by context (affects gender agreement). %%
