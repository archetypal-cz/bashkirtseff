...
Оце вже занадто. Ми закінчуємо вечеряти, коли мені подають візитівку княгині Караджорджевич, яка питає, чи можна її прийняти.
...
І далі — нескінченне гаптування на цю тему. А я цілком відверто сказала їй, що думаю про неї та про всіх них:
%% 2026-09-05T10:33:55 FAB: "нескінченні вишиванки на цю тему" → "нескінченне гаптування на цю тему" — broderies sans fin — embroidering on a theme; «вишиванки» are embroidered shirts, a false friend %%
...
— Я обурювалася, — каже тітка, — зустрічаючи Божидара, який зі мною не вітався й корчив гримаси.
%% 2026-09-05T10:34:32 FAB: "кривив гримасу" → "корчив гримаси" — faisait la grimace — «кривити гримасу» doubles the same idea; «корчити гримаси» is the idiom %%
...
Що вам сказати? Та насамперед те, що я рада поновити стосунки з цими людьми; хлопці мені стають у пригоді.
%% 2026-09-05T10:35:09 FAB: "хлопці мені в пригоді" → "хлопці мені стають у пригоді" — les garçons me sont une ressource — the idiom needs its verb: «стати в пригоді» %%
...
Але княгиня має рацію, ми повелися необачно із Соутцо, і ви й уявити не можете, як мене підбивала до цього тітка. Зрештою, Соутцо був до краю улесливий, ви ж бачили, як він напрошувався. Не дивно, що він мене обмовляє, — він обмовляв при мені геть усіх. Караджорджевичі, може, не кращі, окрім Алексіса, який дуже добра дитина.
%% 2026-09-26T08:14:24 ED: "Карагеоргевич" → "Караджорджевич" — Karageorgevitch: TM canon «Караджорджевич» (normalised 2026-06-14) %%
...
А все ж я могла б чинити більший опір своїм матусям, але оскільки все це мало *приємну* мету, я не втручалася. Більше я цього не робитиму.
%% 2026-09-05T10:35:46 FAB: "я попустила" → "я не втручалася" — j'ai laissé faire — «попустити» today reads as slang (let someone off/get high); «не втручалася» is what she means %%
...
Я не сумнівалася, що Божидар шалено ревнував до того, не з кохання... а просто бозна-чому. Зрештою, це історія нашої комедії, та й ця княгиня така божевільна. Словом, ці Караджорджевичі все ж люди порядні, і про них нічого лихого не скажеш, тоді як Соутцо накоїв чимало паскудств.
%% 2026-09-26T08:14:24 ED: "Карагеоргевич" → "Караджорджевич" — Karageorgevitch: TM canon «Караджорджевич» (normalised 2026-06-14) %%
%% 2026-09-05T10:36:23 FAB: "накоїв чимало бруду" → "накоїв чимало паскудств" — malpropretés — dirty deeds, not dirt; «паскудства» is the count noun for them %%
