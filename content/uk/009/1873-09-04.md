...
%% 2026-08-14T09:30:00 FAB: "маючи на увазі сильну спеку" → "передбачаючи сильну спеку" — «мати на увазі» означає «мати на думці», а не передчувати; ayant en perspective це очікування %%
%% 2026-08-14T09:30:01 FAB: "дати мені її" → "дати мені своє" — «віяло» середнього роду, займенник не узгоджувався %%
%% 2026-08-14T09:30:02 FAB: "тітка купила із російської шкіри" → "тітка купила інше, з російської шкіри" — речення лишалося без додатка (acheta un) %%
...
Полів кінь зовсім ==неслухняний==[^09.21.1] — не хоче бігти риссю, а тільки кроком або галопом. Це мене страшенно дратувало. Я не могла їхати рівним ходом. Мусила то зупинятися на місці, то пускатися в галоп — я була так роздратована, що ладна була завернути назад. Але, на щастя, упертюх послухався, і ми завершили прогулянку по-дружньому. Тільки-но я заходжу — Палашка дає мені маленьку коробку з Парижа. Це фотографії від Валері. Швидко відкриваю. Обидві пози навколішки манірні, особливо та, з опущеними очима. Я не дуже задоволена. Головний, а точніше, єдиний недолік — волосся спереду погано зібране, надто збите докупи, і його забагато, що надає вульгарності. Знімок із руками — найкращий.
%% 2026-08-14T09:30:03 FAB: "що ледь не повернулася" → "що ладна була завернути назад" — j'étais capable de retourner про готовність, а не про майже-дію %%
%% 2026-08-14T09:30:04 FAB: "Обидва знімки на колінах — штучні, надто поставлені" → "Обидві пози навколішки манірні" — poses, а не знімки; affectées це «манірні», а «надто поставлені» було зайвим додатком %%
%% 2026-08-14T09:30:05 FAB: "занадто злиплося" → "надто збите докупи" — trop ensemble про зачіску, зібрану надто щільно, а не про засалене волосся %%
%% 2026-08-14T09:30:06 FAB: "простуватості" → "вульгарності" — за нотаткою OPS: vulgarité у 1870-х різкіше й належить до питомого словника Марі %%
%% 2026-09-26T08:37:02 FAB: "Відкриваю швидко." → "Швидко відкриваю." — порядок J'ouvre vite; українською прислівник способу стоїть перед дієсловом %%

[^09.21.1]: В оригіналі англійською: *unruly*.

%% 009.0022 %%
%% 2026-06-14T13:02:00 CON: APPROVED — Англіцизми (trained, unruly) винесено у виноски коректно; критика фотографій Валері («простуватості») передає Маріїн естетизм. Якість 0.94. %%
