...
%% 2026-06-14T16:45:00 CON: APPROVED - один із найсильніших записів карнета: третьоособове «Мадемуазель», говірка Розалі («Попотик», «тиняється сам-один»), спіраль відчаю про заміжжя/мистецтво. «Покійний» уніфіковано, «лютую/лютуватиму» за локом, [замазано:] та багатомовні вставки (inde ira, To be or not to be) бездоганні. Жива література. %%
