...
Це сонет Данте, який Сантасілья переписав для мене сьогодні ввечері. [Цей сонет не Данте, а Петрарки]
%% 2026-09-26T11:28:42 FAB: "написав мені" → "переписав для мене" — «m'a écrit» = wrote out for me (he copied the sonnet, per TM 070); «написав мені» reads as a letter to her. %%
...
«Запевняю вас, що вам нічого боятися, якщо ви прийдете близько п'ятої до читального салону, освідчення в коханні вам не зроблять, обіцяю вам, та й хіба ви не здатні себе захистити? Хай ваша несміливість заспокоїться й не завадить вам бути ввічливим».
%% 2026-09-26T11:28:42 FAB: "прийшовши близько п'ятої" → "якщо ви прийдете близько п'ятої" — dangling gerund copied from «en vous rendant». %%
...
Я сама віднесла цього листа вниз, а щоб дізнатися, чи його передали, мені довелося вдати перед Розалі, ніби лист міг бути від Пікколеліс, що я хотіла його викрасти, дізнатися, що в ньому, тощо, тощо.
%% 2026-09-26T11:28:42 FAB: "пішла покласти цього листа внизу" → "віднесла цього листа вниз" — «je suis allée poser» motion-verb + infinitive calque. %%
...
Я марно чекала в читальному салоні; від кожного шурхоту серце в мене калатало так сильно, і я так тремтіла, що ще трохи — і я б знепритомніла; я так боялася, що мало не бажала, аби він не прийшов.
%% 2026-09-26T11:28:42 FAB: "за кожним шурхотом моє серце" → "від кожного шурхоту серце в мене" — «à chaque bruit» calqued; Ukrainian drops the possessive for body parts. %%
...
Більше, ніж будь-коли, я займаюся тим, що називаю *ворожінням*[^70.22.3], тобто на кожному кроці, за кожної нагоди кажу собі: якщо така-то річ станеться отак, то трапиться інша, тощо, тощо — і це змушує мене робити безліч дурниць.
%% 2026-09-26T11:28:42 FAB: "за кожним кроком" → "на кожному кроці" — set phrase. %%
...
Добрий товстун Денгоф приходив кілька разів, а ввечері — дитяче зібрання: Зуніка, Сантасілья, Порчінарі та старший за них Каракчоло. Усі вони дуже милі. Я їх зачаровую, і це додає мені запалу. Цей бідолашний малий Сантасілья, на своє нещастя, шалено закоханий у мене... закоханий, як буваєш лише в дев'ятнадцять, закоханий, як Керубіно[^70.22.2]. Це... дивно.
%% 2026-09-26T11:28:42 FAB: "що додає мені запалу… має нещастя бути шалено закоханим… закоханим… закоханим" → "і це додає мені запалу… на своє нещастя, шалено закоханий… закоханий… закоханий" — clausal «що» (ce qui) and «avoir le malheur d'être» calques; the anaphora of «закоханий» kept. %%
...
Це було велике безумство... але його вже вчинено. Пом'якшмо. Листа, який ви зараз прочитаєте, переписує мені Діна.
%% 2026-09-26T11:28:42 FAB: "Це Діна переписує мені листа, який ви зараз прочитаєте." → "Листа, який ви зараз прочитаєте, переписує мені Діна." — «C'est Dina qui» cleft; Ukrainian puts the focus word last. %%
...
Це не для того, щоб вас принизити, і ось доказ: вам радять сподіватися на ваше майбутнє, бо ви не лихий у глибині душі.
%% 2026-09-26T11:28:42 FAB: "і доказ тому — те, що вам радять" → "і ось доказ: вам радять" — «la preuve c'est que» calqued. %%
...
Чого ж ви боялися? Ви цілком здатні були вжахнутися... купи дурниць, так уперто тримаючись цієї жалюгідної думки.
%% 2026-09-26T11:28:42 FAB: "упираючись у цю жалюгідну думку" → "так уперто тримаючись цієї жалюгідної думки" — «s'entêter dans» is obstinacy, not «упиратися в» (to bump into / resist). %%
...
Хіба я маю вигляд авантюрниці? Або ж... і саме це припустили б із найбільшою відразою, — невже ви справді хворі на мозок?
%% 2026-09-26T11:28:42 FAB: "і це те, що припустили б" → "і саме це припустили б" — «c'est là ce que» cleft. %%
...
Можливо, листом навіть краще.
%% 2026-09-26T11:28:42 FAB: "Можливо навіть, що письмовий спосіб кращий." → "Можливо, листом навіть краще." — «le moyen épistolaire» nominal calque. %%
...
Мені *справді* полегшало. І щоб простежити, аби лист передали, і щоб побачити, як від'їжджає пан граф, я зовсім не лягатиму спати.
%% 2026-09-26T11:28:42 FAB: "аби лист було передано" → "аби лист передали" — impersonal passive → the native indefinite-personal form. %%
