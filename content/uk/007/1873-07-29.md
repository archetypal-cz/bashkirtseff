...
О десятій Поль і Валіцький пішли до банкіра й повернулися ==з успіхом==.[^007.0265.1] Нарешті! Нарешті! Після припущень, спротиву, заперечень проти Відня, всіляких тривог, страхів, нещасть усякого роду, що мають на нас звалитися у Відні. Ось ми й рушили!!!!! Від'їзд загалом був дуже веселий. Я, звісно, не обійшлася без сліз, коли говорили проти подорожі.
%% 2026-09-26T08:28:51 FAB: "повернулися ==вдало==" → "повернулися ==з успіхом==" — «returned successful» — «повернулися вдало» reads as «came back safely»; the point is that the money was obtained. %%
%% 2026-09-26T08:28:52 FAB: "Я не забула пролити сльози, коли" → "Я, звісно, не обійшлася без сліз, коли" — «ne pas manquer de» calqued as «не забула»; the ironic Ukrainian equivalent is «не обійшлася без». %%
%% 2026-08-14T13:20:00 FAB: "заперечень, заперечень" → "спротиву, заперечень" — "oppositions" and "objections" are two different obstacles and the repetition read as a slip; "обрушитися" → "звалитися" as the natural Ukrainian verb for calamity. %%
...
Усі підтримали пропозицію, пан Анічков теж, і з-за обіднього столу пішли просто до нашої кімнати. Я сказала:
%% 2026-09-26T08:28:53 FAB: "і від обіду пішли просто" → "і з-за обіднього столу пішли просто" — «du dîner on alla» — «від обіду» is not Ukrainian for leaving the table. %%
...
І до того ж я така весела цього вечора! Ця веселість охопила мене, як тільки ми покинули Ніццу. Пан Анічков, як серйозна людина, продиктував мені заповіт. Я не могла зберігати серйозність, на кожну його фразу я робила зауваження й висміювала все. Він мусив мені сказати:
%% 2026-09-26T08:28:54 FAB: "Він був змушений мені сказати:" → "Він мусив мені сказати:" — «Il fut forcé» carried over as a passive participle; the modal «мусив» is the Ukrainian form. %%
%% 2026-08-14T13:21:00 FAB: "А потім — я така весела" → "І до того ж я така весела" — another "et puis" that adds a reason rather than a next moment. %%
...
У Ніцці за сніданком казали, що князь Ґаліцин пускається берега, і його дружина сказала, що він каже, що вона для нього занадто стара.
%% 2026-08-14T13:22:00 FAB: "князь Ґаліцин витівкує" → "князь Ґаліцин пускається берега" — "витівкувати" is barely a verb; the Ukrainian idiom says exactly what "faire des folies" means about a husband who finds his wife too old. %%

%% 007.0279 %%
%% [#Kernberger](../../_original/_glossary/culture/literature/KATHERINE_KERNBERGER.md) %%
%% -- Dix ans de difference n'est rien du tout pour un homme m'a dit mon mari, dit-elle. %%
— Для чоловіка десять років різниці — зовсім нічого, — казав мені мій чоловік, — каже вона.
%% 2026-09-26T08:28:55 FAB: "— Десять років різниці — зовсім нічого для чоловіка, казав мені мій чоловік," → "— Для чоловіка десять років різниці — зовсім нічого, — казав мені мій чоловік," — French word order put «pour un homme» last, which blurred «man/husband» with the next «чоловік»; also the missing dash before the speech tag. %%
...
— *Мусінка*, я хочу видати вас заміж за герцога Гамільтона. Пані Башкирцева, я знайшла для неї — це якраз те, що треба.
...
— Ні, що за думка, у нього є коханка, а чоловік, у якого є коханка, не повинен одружуватися. Бо перший рік він обожнюватиме дружину, але потім зустріне свою колишню коханку в друга, побачить її блискучою, оточеною увагою (нафарбованою й фальшивою — це правда), подумає, що ось скарб, який він утратив, повернеться до неї, а дружину — геть. Ні, чоловік, який звик проводити час у жінки, який звик до неї! Це неможливо.
%% 2026-09-26T08:28:56 FAB: "він має коханку; чоловік, який має коханку," → "у нього є коханка, а чоловік, у якого є коханка," — «il a une maîtresse» twice calqued with «мати»; Ukrainian possession «у нього є». %%
%% 2026-08-14T13:23:00 FAB: "в оточенні" → "оточеною увагою" (the bare phrase had nothing to surround her with); "а дружина — геть" → "а дружину — геть" — the wife is thrown out, not throwing herself. %%
...
— Чому б він не міг проводити час із дружиною так само, як проводив із коханкою? О! Звісно, якщо дружина візьметься маринувати, консервувати фрукти, одягне неохайний перкалевий халат і стане *ощадливою господинею*; звісно, тоді чоловік шукатиме розваг — «це добра господиня, — скаже він, — я її ціную, але не можу кохати, як кохають жінку».
%% 2026-08-14T13:24:00 FAB: "перкалевий нехлюйський халат" → "неохайний перкалевий халат"; "ощадливою домогосподаркою" → "ощадливою господинею" — "домогосподарка" is a twentieth-century word, and "господиня" matches "добра господиня" in the same speech. %%
...
Бачачи, що вона сприймає це серйозно, я не наполягала — це було б непристойно. Вона вела далі:
%% 2026-09-26T08:28:57 FAB: "Вона продовжила:" → "Вона вела далі:" — «Elle continua» — «продовжила» used absolutely is the Russian pattern; «вела далі» is the Ukrainian narrative formula. %%
...
І в тому ж дусі ще довго. Вона боїться, що Гамільтон може завадити моєму шлюбу з Мілорадовичем. Вона знає, що я кохаю, і їй це не до вподоби. Вона боїться, і не без підстав, що моє кохання до Гамільтона завадить мені вийти за іншого. Вона розписує всі вади Гамільтона й усі чесноти іншого. Але саме ці вади я й люблю! Що таке хлопчик чотирнадцяти років! Молокосос! Він красивий, молодий, багатий, вільний, у нього нема коханки, кажуть мені. Матиме, якщо не має! Їй-Богу! І буде ще гірше. Хай йому чорт! Ну то я волію герцога з усіма його *вадами. Якщо він* мене кохатиме, то не кохатиме іншої. І це кохання буде безцінним, бо він знає, кого кохає, а молодий дурень кохає все, що носить спідницю.
%% 2026-09-26T08:28:59 FAB: "І в такому тоні довго." → "І в тому ж дусі ще довго." — «Et sur ce ton» is rendered «у тому ж дусі» elsewhere in the carnet; «у такому тоні» is the calque. %%
%% 2026-09-26T08:29:00 FAB: "Вона виставляє всі вади" → "Вона розписує всі вади" — «exposer» here is laying out a case; «виставляти» means putting on display. %%
%% 2026-09-26T08:29:01 FAB: "мене кохатиме, він не кохатиме іншу" → "мене кохатиме, то не кохатиме іншої" — doubled subject copied from French; under negation the object goes to the genitive. %%
%% 2026-08-14T13:25:00 FAB: "багатий, один" → "багатий, вільний" ("seul" here means unattached, and "один" read as solitary); "А чорт забирай!" → "Хай йому чорт!" — the first is the Russian oath in Ukrainian clothing. %%

[^007.0265.1]: В оригіналі англійською: *successful*.

%% 2026-06-14T15:46:00 CON: APPROVED - The comic will-dictation scene at Monte-Carlo and Maman's anti-Hamilton speech (007.0284-0285) carry real wit; "молокосос"/"молодий дурень кохає все, що носить спідницю" keeps the bite. Карбованці convention correct. (fid 0.96 nat 0.95 voice 0.97 lit 0.96 → 0.96) %%
