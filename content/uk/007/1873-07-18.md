...
%% 2026-08-14T11:00:00 FAB: "суне свого носа всюди" → "скрізь пхає свого носа" — "met son nez partout" has a ready Ukrainian idiom; "суне носа" copies the Russian turn of phrase. %%
...
%% 2026-08-14T11:01:00 FAB: "накрили" → "розклали прибори" — "les couverts mis" is the cutlery being laid out; an objectless "накрили" left the picnic gesture hanging. %%
...
Я трохи розвеселилася, а потім, на моє велике задоволення, ми пішли ==рибалити==,[^007.0043.1] — я, Поль, Валіцький і Говард. У мене не було вудки, але я з цікавістю стежила за їхніми. Вперше я відчуваю цю втіху, це так захопливо! Ми просиділи три години мовчки, ==ловлячи рибу==,[^007.0043.2] і вони здалися мені трьома хвилинами. Потім приходять Діна й мама й починають розмовляти, Говард занадто делікатний, щоб сказати, що це заважає, а на мої слова ніхто не зважає. Потім ще більше нещастя — Говардиха з *сином* і покоївкою. Що за тягар, Боже! Піймали чотири жалюгідні рибчини, ловили вугра, він ворушився, і ніхто не міг його добити, Говард поранив йому хвіст, він ворушиться — тоді я поклала цьому край, відтявши йому голову. Вдома дивуються моїй жорстокості, але я не падаю духом; я маю для почуттів інше застосування, я волію допомогти нещасному, ніж кривитися через вугра чи голуба. Назад ми (родина) їхали разом, і замість старої з нами був Говард. Він теж кумедний: штани в дрібну сіру клітинку, піджак такий самий, але жовтий, краватка з тисячею кольорів, безглуздий англійський комір, капелюх на потилиці й люлька, і дурнуватий вигляд англійця другого сорту з Тиру. Хоче вдавати з себе філософа, каже, що стомився від усього. Але що мені приємно — він говорив про коней. Казав, що раніше мав яхту, але після одруження... Я сказала, що пароплав краще: «У герцога Гамільтона є дуже гарний». Сьогодні вранці він сказав тітці, що бачив у Відні Джою й Гамільтона, що той *її цілком покинув*, на що дідусь каже, що це неможливо, Жорж теж, тітка наполягає — я б хотіла в це вірити.
%% 2026-09-26T08:24:04 FAB: "Який пакунок, Боже!" → "Що за тягар, Боже!" — «Quel paquet» is the burden of unwanted company; «пакунок» (a parcel) is the French word taken literally. %%
%% 2026-09-26T08:24:05 FAB: "але я не зневірююся" → "але я не падаю духом" — «je ne me décourage pas» is not losing heart; «зневірюватися» means losing faith, which here, after her prayer crisis, misleads. %%
%% 2026-09-26T08:24:06 FAB: "ніж корчити гримаси заради вугра чи голуба" → "ніж кривитися через вугра чи голуба" — «faire la grimace pour» calqued; Ukrainian «кривитися через щось». %%
%% 2026-09-26T08:24:07 FAB: "На зворотному шляху ми були (родина) разом" → "Назад ми (родина) їхали разом" — «Au retour nous étions ensemble» copied with «бути»; Ukrainian says who rode with whom. %%
%% 2026-09-26T08:24:08 FAB: "що останній *її цілком покинув*" → "що той *її цілком покинув*" — «ce dernier» calqued as «останній»; Ukrainian uses the demonstrative. %%
...
%% 2026-08-14T11:02:00 FAB: "я все вирішила, відтявши йому голову" → "я поклала цьому край, відтявши йому голову" — "je mis fin" is ending the animal's suffering, not settling a question; the old reading made the sentence a non sequitur. %%
%% 2026-08-14T11:03:00 FAB: "я кладу почуття в інше місце" → "я маю для почуттів інше застосування" — "je place le sentiment autre part" is Marie budgeting her compassion; the literal version is not Ukrainian. %%
%% 2026-08-14T11:04:00 FAB: "безглуздий вигляд англійця" → "дурнуватий вигляд англійця" — French distinguishes "hébété" (collar) from "bête" (his look); the doubled "безглуздий" flattened both. %%
%% 2026-08-14T11:05:00 FAB: "Хоче бути філософом" → "Хоче вдавати з себе філософа" — "faire le philosophe" is posing, not aspiring; the contempt is the whole point of the sentence. %%
...
%% 2026-08-14T11:06:00 FAB: added the comma before "як лакей про свого пана" — comparative clause with its own subject. %%
...
І далі в тому ж дусі. Жорж хотів сказати, що Говард нічим не кращий за Дрійя, сьогодні вранці про цього Дрійя сперечалися.
%% 2026-09-26T08:24:09 FAB: "сьогодні вранці були суперечки про цього Дрійя" → "сьогодні вранці про цього Дрійя сперечалися" — «il y avait des débats» nominal; Ukrainian uses the verb. %%
...
Почувши ім'я Гамільтона, вона змінилася на обличчі. Не любить, коли я про нього говорю, — їй потрібен Мілорадович.
%% 2026-09-26T08:24:10 FAB: "Вона змінилася на обличчі при згадці імені Гамільтона." → "Почувши ім'я Гамільтона, вона змінилася на обличчі." — «au nom de Hamilton» turned into a heavy nominal «при згадці імені»; the gerund of perception is the native shape. %%
%% 2026-02-16T19:15:00 OPS: "змінилася в обличчі" → "змінилася на обличчі" — more natural Ukrainian (sev B) %%
%% 2026-08-14T11:07:00 FAB: "при імені Гамільтона" → "при згадці імені Гамільтона"; "для неї потрібен Мілорадович" → "їй потрібен Мілорадович" — the first was a bare calque, the second wrong government ("потрібен" takes the dative). %%
...
— Здається, його в нього вже нема.
%% 2026-09-26T08:24:11 FAB: "Він його вже не має, здається." → "Здається, його в нього вже нема." — «Il ne l'a plus» calqued with «мати»; Ukrainian possession is «у нього є/нема». %%
...
Ніби я просила в нього всіх цих пояснень!
%% 2026-09-26T08:24:12 FAB: "Ніби я просила всі ці пояснення!" → "Ніби я просила в нього всіх цих пояснень!" — «просити» of something abstract takes the genitive; the accusative copied the French direct object. %%
...
Тоді мама: «Тридцять вісім — це ще не старість», — і далі розмова про вік. Говард каже, що герцогу тридцять шість.
%% 2026-09-26T08:24:13 FAB: "«Тридцять вісім — це не старий»" → "«Тридцять вісім — це ще не старість»" — «n'est pas vieux» after a number: Ukrainian says «це не старість», the bare adjective dangles. %%

%% 007.0063 %%
%% -- Ce n'est pas possible, il a l'air d'avoir vingt-neuf. %%
— Не може бути, на вигляд йому двадцять дев'ять.
%% 2026-09-26T08:24:14 FAB: "він виглядає на двадцять дев'ять" → "на вигляд йому двадцять дев'ять" — «виглядає на» is a Russianism; Ukrainian «на вигляд йому». %%
...
Говард розповідав мені про коней і перегони, взимку він стрілятиме. Каже, що матиме коня, такого ж доброго, як усі, що бігають у Ніцці, а може, й кращого, за дві-три тисячі франків — це трохи казкове, замало. Але якщо це так, то *з Божою допомогою* я матиму коня, який бігатиме в Ніцці. Яка я щаслива і невдячна Богові, що прошу Його про всілякі речі. Я маю те, чого бажаю. Я сказала дурницю, я не невдячна, бо щаслива я саме завдяки тому, про що прошу і що Він мені дає. Тітка й мама мене обожнюють, усі їхні думки спрямовані на мене, особливо мамині — вона б шкіру з себе здерла, аби мені догодити. Тітка цими днями робиться такою доброю до мене, вона часто мене пестить, і я ціную це, бо ці пестощі рідкісні й нові.
%% 2026-09-26T08:24:15 FAB: "невдячна Богові, просячи Його про всілякі речі" → "невдячна Богові, що прошу Його про всілякі речі" — the gerund copied «en Lui demandant»; the reason clause is how Ukrainian says why she is ungrateful. %%
%% 2026-09-26T08:24:16 FAB: "бо саме завдяки речам, які я прошу і які Він мені дає, я щаслива" → "бо щаслива я саме завдяки тому, про що прошу і що Він мені дає" — the «c'est par … que» cleft carried over, plus «речі, які я прошу» (wrong government); «про що прошу» is correct and lets the sentence close on the gift. %%
%% 2026-08-14T11:08:00 FAB: "за два-три тисячі франків" → "за дві-три тисячі франків" — "тисяча" is feminine. %%
%% 2026-08-14T11:09:00 FAB: "невдячна до Бога" → "невдячна Богові" — "невдячний" governs the dative. %%
%% 2026-08-14T11:10:00 FAB: "починає бути такою доброю зі мною" → "робиться такою доброю до мене" — "commence à être" rendered word for word reads as a report; "робиться" carries the same gradual thaw in Ukrainian. %%
...
Та чи бачив хто коли таку малу дівчинку, як я, зі скакуном? Я справлю фурор! Які жокейські кольори? Сірий і вишневий — ні, яка дурниця! Зелений і ніжно-рожевий. Це забагато Його доброти. Він мене осипає дарами, це надприродна річ для мене — кінь! О! Яка я щаслива, задоволена, яке я дурне створіння! Як не відлити зі свого переповненого кубка бідним, які нічого не мають. Я отримую дві тисячі п'ятсот франків на місяць, даю десять відсотків бідним, це становить двісті п'ятдесят франків. Я хотіла б робити більше. О! Та яка ж я щаслива!!!!!!!!!
%% 2026-09-26T08:24:18 FAB: "Як не розлити зі свого переповненого кубка" → "Як не відлити зі свого переповненого кубка" — «verser» to the poor is pouring out a share; «розлити» means to spill. %%
%% 2026-08-14T11:14:00 FAB: "маленьку, як я" → "таку малу дівчинку, як я" — "une petite" needs its noun in Ukrainian; Marie's own "une petite fille" further down supplies it. %%
%% 2026-08-14T11:15:00 FAB: "Він мене осипає" → "Він мене осипає дарами" — "combler" is transitive in Ukrainian too; the bare verb left the sentence unfinished. %%
...
%% 2026-08-14T11:16:00 FAB: "Я зможу через цього коня з ним познайомитися" → "Завдяки цьому коневі я зможу з ним познайомитися" — "через" reads as blame; the horse is the happy means, and fronting it lets the sentence end on the meeting. %%
...
%% 2026-06-14T15:35:00 CON: APPROVED - Long set-piece (Var picnic, fishing, the eel, Howard the "Anglais deuxieme qualite", the cheval-de-course ecstasy). Marie's cruelty/charity self-justification and her racehorse rapture both fully alive; English insertions footnoted; OPS "на обличчі" fix confirmed. (fid 0.95 nat 0.95 voice 0.97 lit 0.95 → 0.96) %%
