...
Від'їзд диви, пожирачки сердець.
%% 2026-09-26T09:21:42 FAB: "Від'їзд діви, пожирачки сердець." → "Від'їзд диви, пожирачки сердець." — "діва" is a maiden/virgin; "la diva" is «дива» (as in 021.0295 "поруч із *дивою*"). A one-letter slip that inverted Marie's sarcasm. %%
...
Прокидаюся о першій — голова паморочиться. Це востаннє. Отак я себе й нищу.
%% 2026-08-14T13:00:00 FAB: "голова крутиться" → "голова паморочиться" — the Ukrainian idiom for dizziness. %%
%% 2026-09-26T09:21:43 FAB: "Я нищу себе таким чином." → "Отак я себе й нищу." — calque hunt: "de cette façon" copied as a trailing "таким чином"; Ukrainian fronts "отак". %%
...
Між іншим, зайшла розмова про кравчинь:
%% 2026-09-26T09:21:44 FAB: "зайшла розмова про кравчих:" → "зайшла розмова про кравчинь:" — "кравчий" is a court cupbearer; "couturières" are «кравчині» (genitive plural «кравчинь», the form used elsewhere in the tree). %%

%% 021.0427 %%
%% — Mais pourquoi vous adressez-vous, Madame, aux couturières d'ici, dit Papa. %%
— Але чому ви звертаєтесь, мадам, до місцевих кравчинь? — каже Папа.
%% 2026-09-26T09:21:45 FAB: "до місцевих кравчих?" → "до місцевих кравчинь?" — same error as 021.0426. %%
...
— Але *Душенька* цього не потребує, — каже Жерікке, торкаючись ціпком краю моєї сукні і трохи піднімаючи її цим рухом.
%% 2026-08-14T13:01:00 FAB: "тростиною" → "ціпком" — carnet-wide: "тростина" follows the Russian "трость". %%
%% 2026-09-26T09:21:46 FAB: "торкаючись своїм ціпком до низу моєї сукні" → "торкаючись ціпком краю моєї сукні" — calque hunt: "avec sa canne" copied with the possessive "своїм"; "le bas de ma robe" is the hem, "низ" as a noun of a dress is unidiomatic. %%
...
— Бароне, бароне! — вигукнула мама з гнівом. — Те, що ви робите, — нечемно; я бачила, як ви робили це з дамами, які готові це дозволити, — але з панночками такі манери неприпустимі!
%% 2026-09-26T09:21:47 FAB: "— Барон, барон!" → "— Бароне, бароне!" — vocative, as fixed by the earlier pass in 021.0464. %%
...
По-моєму, так йому й треба — він надто забувався; потрібно було щось таке, щоб поставити його на місце як слід. Я злякалась — так гнівно мама це сказала. Пани ідуть за нами, опустивши голови; ми з Діною йдемо поруч із маркізом і спокійно говоримо про всілякі речі, наче нічого й не було. Жерікке дуже несміливо підходить і йде поруч зі мною й вмішується в розмову — завжди несміливо. У мене таке добре серце, що мені ніяково за нього.
%% 2026-09-26T09:21:48 FAB: "Вважаю, що так і треба" → "По-моєму, так йому й треба" — calque hunt: "Je trouve que c'est bien fait" copied as "Вважаю, що так і треба"; the Ukrainian idiom for "serves him right" is "так йому й треба". %%
%% 2026-09-26T09:21:49 FAB: "Жерікке дуже несміливо підходить іти поруч зі мною" → "Жерікке дуже несміливо підходить і йде поруч зі мною" — calque hunt: "vient marcher à côté de moi" copied as "підходить іти"; Ukrainian coordinates the two verbs. %%
...
Усі разом ідемо на концерт і, не сідаючи, залишивши маркіза з маркізою, а графа — з матір'ю (він ревнує до Жерікке), піднімаємося до Аннет-і-Лубен.
%% 2026-08-14T13:02:00 FAB: "на музику" → "на концерт" — carnet-wide normalisation (last occurrence). %%
...
Піднімаємося спокійно — мама веде просту розмову. Жерікке підіймається прямо — я так само. Я лізу, як мавпа, чіпляючись за трави й гілки, спираючись на ціпок барона. Він ішов попереду. Підйом такий крутий, що під кінець голова в мене закрутилась і я відчула, як б'ється — наче годинник Мортó — посередині спини. Барон тепер пристойний, як Тансле. Ми сідаємо на лаву їх чекати — він просить дозволу витерти мої черевики; я дозволяю. Але на мій рух він зробив інший рух, що означав:
%% 2026-08-14T13:03:00 FAB: "тростину" → "ціпок"; "Підйом такий круте" → "Підйом такий крутий" (agreement). %%
%% 2026-09-26T09:21:50 FAB: "Підйом відбувається спокійно" → "Піднімаємося спокійно" — calque hunt: "La montée s'effectue" copied as a nominal "Підйом відбувається"; Ukrainian uses the verb. %%
...
Говоримо про Ніццу, про ніццьке товариство. Вони не приходять. Тоді ми встаємо — і за кілька кроків застаємо їх на іншій лаві — сидять і чекають на нас.
%% 2026-09-26T09:21:51 FAB: "і за кілька кроків знаходимо їх, що сидять на іншій лаві і чекають на нас." → "і за кілька кроків застаємо їх на іншій лаві — сидять і чекають на нас." — calque hunt: "les trouvons assis ... nous attendant" copied as "знаходимо їх, що сидять"; Ukrainian "застаємо" plus a plain clause. %%
...
На вершині п'ємо молоко. Розмова проста й стримана — пани схожі на *мух узимку.* Говорять про мою тітку: мама каже, що впевнена — барон їй сподобається і вона барону. Я, дурна, показую, скільки в мене досвіду у справах залицяння — не любовних, тобто. Усі мовчки дивуються — мама більше за всіх. Спускаємося. Діна хоче стрибати й скакати, як *лань;* коли я підіймалась — я підіймалась із гідністю й природно, а вона розійшлася і уявила себе метеликом.
%% 2026-08-14T13:04:00 FAB: "необачність" → "дурість" ("la bêtise", as elsewhere); "яким досвідом маю" → "скільки в мене досвіду" — the old phrase was ungrammatical where the French asks "combien j'ai". %%
%% 2026-08-14T13:04:30 FAB: "розбуялась" → "розійшлася" — "s'emporte" is getting carried away; "розбуятися" is a rare word for vegetation running wild. %%
%% 2026-09-26T09:21:52 FAB: "Я маю дурість показати" → "Я, дурна, показую" — calque hunt: "J'ai la bêtise de montrer"; same fix as 021.0392. %%

%% 021.0439 %%
%% [#Kernberger](../../_original/_glossary/culture/literature/KATHERINE_KERNBERGER.md) %%
%% Maman reste en arrière et Gericke nous reconduit jusqu'au Pouhon. %%
Мама лишається позаду — Жерікке проводить нас до Пуону.
...
У Пуоні відбувається нарада щодо завтрашньої екскурсії. Нас вісімнадцять: маркіза, графиня Гіріні, мама, Давіньйон, Жозефіна, Жанна, панна Фоліньо, графиня Мержеєвська, панна Вітославська. Граф Гіріні, граф, Поль, Валіцький, пан Фоліньо, пан Вітославський.
%% 2026-08-14T13:05:00 FAB: "до Пуона" → "до Пуону"; "Межевська" → "Мержеєвська" — both normalised to the forms used elsewhere in the carnet. %%
%% 2026-09-26T09:21:53 FAB: "Давіньон, Жозефіна" → "Давіньйон, Жозефіна" — name form aligned with the carnet and tree majority «Давіньйон» (see 021.0388). %%
...
Усі засмучені від'їздом Базілевич. Іду з Полем на манеж і замовляю наших коней. Приїхав якийсь пан, на вигляд цікавий.
%% 2026-09-26T09:21:54 FAB: "Прибув якийсь пан — із цікавим виглядом." → "Приїхав якийсь пан, на вигляд цікавий." — calque hunt: "qui a l'air intéressant" copied as "із цікавим виглядом"; Ukrainian says "на вигляд цікавий", and "прибув" is officialese for "est arrivé". %%
...
І справді, чоловіків тут чимало.
%% 2026-09-26T09:21:55 FAB: "Факт той, що тут чимало чоловіків." → "І справді, чоловіків тут чимало." — calque hunt: "Le fait est que" copied as "Факт той, що" (TM-listed calque); here it concedes mother's point. %%
...
— *І в Бадені я б ніколи не познайомилась із Гамільтонами, якби одного ранку я не прогулювалась із Діною і не зайшла до ресторану — і там я не побачила опудала, монстра в білих чоботях із червоними відворотами, в картатому капелюсі, жахливої огрядності. І це чудовисько підійшло й почало репетувати, щоб йому подали омарів,* foie gras *тощо. Ось, думаю я, як отакий мужик* жере. *Тоді я спитала — і мені сказали, що це справжній мужик, опудало.* — Хто ж тобі це сказав? — питаю я, вся зворушена, тихим голосом. О, я не сподівалася на щастя почути про нього. *Це єдина людина, яку ти мені показала.*
%% 2026-08-14T13:06:00 FAB: "жахливої тілесності" → "жахливої огрядності" — "une masse effrayante" is bulk, not corporeality as an abstraction. %%
%% 2026-08-14T13:06:30 FAB: "цей вид мужика" → "отакий мужик" — "cette espèce de moujik" is a contemptuous "this sort of", not a taxonomic category. %%
...
%% — Oh quelle idée ! %%
— О, що за вигадка!
%% 2026-09-26T09:21:56 FAB: "— О, яка думка!" → "— О, що за вигадка!" — "Oh quelle idée !" is dismissive; "яка думка!" reads as admiration. %%
...
Після обіду заходимо до маркізи на годину. Тягнемо жеребки — хто поїде в бричці, хто в додатковому екіпажі.
%% 2026-08-14T13:07:00 FAB: "в брику" → "в бричці" — "брика" is not a Ukrainian word; the carriage is "бричка", the form used in 021/1874-07-23. %%
...
У мене їх тепер двоє — велике чорне і це, майже таке саме велике.
%% 2026-08-14T13:08:00 FAB: comma added in "ні очам, ні вухам"; "таке ж" → "таке саме" ("такий же" follows the Russian). %%
...
Іду до Казино у сірій сукні й капелюсі, з віялом. Це мій перший подарунок. *Ось бачиш — подарунки й віяло, за якими ти зітхаєш,* — каже мама. Усі дивуються, що ми без вишуканого вбрання; лише Діна у великій чорній сукні від Ворта. Лафер'єр — нікчемність порівняно з Вортом. Є лише Він. Діна вдягла цю сукню для барона — після від'їзду Базілевич. Це зауважила не я — мама. Бал дуже жвавий. Я танцюю три-чотири танці. Йдемо до бюро Кірша. Мама, Діна, я, де Жаль, Вітославський, граф, Грек.
%% 2026-08-14T13:09:00 FAB: "сіра сукня, капелюх і з віялом" → "у сірій сукні й капелюсі, з віялом" — the old line mixed a bare nominative list with a prepositional phrase. %%
%% 2026-09-26T09:21:57 FAB: "про які ти зітхаєш" → "за якими ти зітхаєш" — "soupirer après" is to pine for; Ukrainian "зітхати за чимось". %%
...
«Це чарівно, бароне — справді дуже люб'язно».
%% 2026-08-14T13:10:00 FAB: "барон" → "бароне" — vocative. %%
...
— *Він справді вперше в житті залицяється до панночки — і злякався власної сміливості.*
%% 2026-09-26T09:21:53 FAB: "Це справді перший раз у його житті, коли він залицяється до панночки" → "Він справді вперше в житті залицяється до панночки" — calque hunt: "C'est la première fois de sa vie qu'il" copied as the cleft "Це перший раз ..., коли"; Ukrainian uses "вперше в житті". %%

%% 021.0469 %%
%% — Il ne fait pas la cour,* dis-je. *Et comment donc ? Bien sûr*. Mais ce n'est pas cela. %%
— Він не залицяється, — кажу я. — Та як же? Звичайно ж. Але річ не в тім.
%% 2026-09-26T09:21:54 FAB: "Але це не так." → "Але річ не в тім." — "Mais ce n'est pas cela" means "that's not the point"; "це не так" reads as "that's not true", contradicting her "Bien sûr" just before. %%
...
Поляк ревнує до Жерікке. Який огидний характер — хитрий, потайний, загадковий, проблематичний.
%% 2026-08-14T13:11:00 FAB: "прихований" → "потайний" — of a person, "dissimulé" is secretive; "прихований" describes concealed things, not concealing people. %%
...
— Спробую вас потішити, пане, прикрасивши вас, — і я прикріпила йому до петлиці котильйонну кокарду, яку мама прихопила в Кірша.
%% 2026-08-14T13:12:00 FAB: "захопила від Кірша" → "прихопила в Кірша" — "emporter de chez" takes "в" + genitive in Ukrainian. %%
...
Я тут поводжуся досить кокетливо — мене знають (щойно почула з вулиці слово, наприкінці книги) такою. Зрештою, нічого поганого в цьому немає.
%% 2026-08-14T13:13:00 FAB: "Я виявляюсь тут досить кокетливою" → "Я тут поводжуся досить кокетливо" — "je me montre" is how she conducts herself, not something that turns out to be true of her. %%
