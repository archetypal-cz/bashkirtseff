...
А поки що я роблю цю жінку, яка, по суті, є тією постаттю, що стоїть, постаттю іншої Марі з картини. Тільки в скульптурі, без одягу, а якщо взяти за натуру дівчину, виходить чарівна Навсікая. Вона впустила голову в долоні й плаче. У позі стільки правдивого розпачу, такого повного, такого юного, такого щирого, такого сумного, що мене це дуже захоплює.
%% 2026-09-26T07:49:17 FAB: "і, узявши за натуру дівчину, виходить" → "а якщо взяти за натуру дівчину, виходить" — dangling adverbial participle with an impersonal main verb (prenant une jeune fille cela fait) %%
