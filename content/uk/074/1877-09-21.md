...
Назвіть мені хоч одне моє дотепне слово чи розумний вчинок. Самісінька дурість. Я вважала себе гострою на розум — я безглузда. Я вважала себе гордою — а завжди робила ницості. Я вважала себе сміливою — а я боягузлива. Я вважала, що маю талант, — і не знаю, куди я його поділа. І з усім тим — претензія писати чарівні речі! Ах, мій Імператоре!
%% 2026-09-26T12:03:25 FAB: "І при цьому — претензія" → "І з усім тим — претензія" — "при цьому" is a Russianism flagged in the uk trap list; "з усім тим" carries "avec ça" %%
%% 2026-09-26T12:03:25 FAB: "Вкажіть мені хоча б одне дотепне слово чи розумний вчинок з моїх." → "Назвіть мені хоч одне моє дотепне слово чи розумний вчинок." — "de moi" tacked on as "з моїх" copies the French postposed complement; Ukrainian uses the possessive before the noun %%
%% 2026-08-15T20:55:00 FAB: "робила речі, що принижують гідність" → "робила ницості" — a five-word gloss in a paragraph built of short antitheses; "bassesse" has its own Ukrainian noun %%
%% 2026-08-15T20:55:00 FAB: "амбіція" → "претензія" — "prétention" is the claim she cannot back, not an ambition %%
...
Ви, можливо, приймете за дотепність те, що я щойно сказала, — воно на неї схоже, але це не вона.
%% 2026-09-26T12:03:25 FAB: "— це схоже, але не те." → "— воно на неї схоже, але це не вона." — "ça en a l'air mais ça n'en est pas" lost its pronoun "en" (wit); the Ukrainian now says what it resembles and is not %%
%% 2026-06-10T12:00:00 RED: HIGH Para 074.0405 - "прийдете" (will arrive) for "Vous prendrez pour" → "приймете за дотепність" (will take for wit) %%
Я вмію точно себе судити, що й справляє враження скромності та ще багато чого. Я ненавиджу себе!
...
%% 2026-08-15T20:58:00 FAB: "ніжна маленька гордість" → "якесь маленьке почуття ніжної гордості" — "un petit sentiment de" had been squeezed out, and with it the self-mocking hedge %%
...
%% Berthe m'écrit. %%
Берта мені пише.
%% 2026-09-26T12:03:25 FAB: "Берт мені пише." → "Берта мені пише." — name form: the same Berthe is «Берта» at 074.0027 and 074.0062 and in 225 places across the tree; the undeclined "Берт" was a slip %%
...
%% 2026-08-15T21:01:00 FAB: "проживання і я дійшла" → "проживання, і я дійшла" — missing comma between the two clauses %%

%% 074.0410 %%
%% Mes robes m'occupent le plus. %%
Найбільше мене займають мої сукні.
%% 2026-08-15T21:03:00 FAB: "Більше за все" → "Найбільше" — "більше за все" copies the Russian superlative %%
...
%% 2026-08-15T21:06:00 FAB: "суспільство Неаполя" → "неаполітанське товариство" — "la société" here is the social set, which this carnet calls "товариство" throughout %%
