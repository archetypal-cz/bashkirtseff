...
Велике, Велике, Велике питання: чи буду я наступного року вольфізована [sic].[^101.263.1] І сама думка, що цього може й не статися, кидає мене у смертельну тривогу.
%% 2026-09-26T07:55:29 FAB: "питання — це знати:" → "питання:"; "що я можу не бути нею" → "що цього може й не статися" — «c'est de savoir» calque; «нею» had no antecedent (ne pas l'être) %%
