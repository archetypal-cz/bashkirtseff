...
Портрет Божидара видається мені... добрим. Жюліан каже, що це може бути великий успіх, що це дуже оригінально, дуже свіжо і що скидатиметься на вправного Мане.
%% 2026-09-26T08:02:34 FAB: "Жулян" → "Жюліан" (TM lock); "виглядатиме як" → "скидатиметься на" — «виглядати як» is a Russianism %%
...
Але це небо... О! Якби це була пастель... Та ні, я хочу в натуральну величину. Так вона дужче вражатиме.
%% 2026-09-26T08:02:34 FAB: "Так буде хвилюючіше" → "Так вона дужче вражатиме" — comparative of the participle «хвилюючий» is a Russian-shaped form; empoignant = gripping %%
...
За два місяці я можу написати ще одну картину. У грудні я починаю статую й портрет Діни. Ах! Боже мій, пишімо менше й працюймо. Я боюся застудитися в Бретані, а якщо захворію — усе пропало. І мені треба добре берегтися, бо моє жалюгідне дихання погіршується, а я худну.
%% 2026-09-26T08:02:34 FAB: "мені лишається тільки добре триматися" → "мені треба добре берегтися" — «je n'ai qu'à me bien tenir» = I had better watch myself (health), not «hold on» %%
