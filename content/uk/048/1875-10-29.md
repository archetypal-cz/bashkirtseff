...
Ще один пеньюар, замащений фарбою, у моїй гардеробній на другому поверсі. Там фарбують, а оскільки я ходжу туди дивитися на замок, то й мащуся.
%% 2026-09-26T10:14:16 FAB: "Там малюють" → "Там фарбують" — СМИСЛ: «On peint» тут про малярів, що фарбують приміщення (звідси й пеньюар у фарбі); «малюють» — про картини %%
...
Хоч яка малоприваблива розмова з Пепіно, мені вистачає терпіння тримати його коло себе, тож володар замку застає його поряд зі мною, *вельми заклопотаною,* — заклопотаною аж так, що я помічаю його, лише коли він підходить і вітається.
%% 2026-08-14T13:15:00 FAB: "Попри те, яка малопринадна розмова Пепіно" → "Хоч яка малоприваблива розмова з Пепіно" — попереднє починалося з важкої канцелярської зв'язки й лишало «розмова Пепіно» замість «розмова з Пепіно»; поступова конструкція «хоч яка…» легша й українськіша. %%
...
Щойно ми сідаємо до столу, як Ольга мені підморгує, а ми звикли розуміти одна одну без слів, тож я розумію й піднімаюся на третій поверх, несучи в хустинці грудку цукру; у темряві намацую пляшечку з любовним зіллям, — ви ж його не забули, чи не так? — капаю кілька крапель на грудку цукру й спускаюся назад, щоб сісти між Пепіно й д'Одіффре.
%% 2026-09-26T10:14:16 FAB: "спускаюся назад, сідаючи між" → "спускаюся назад, щоб сісти між" — «redescends me mettre» — мета руху; дієприслівник «сідаючи» робив дві дії одночасними %%
%% 2026-09-26T10:14:16 FAB: "і за тією звичкою, яку ми маємо — розуміти одна одну без слів, — я розумію" → "а ми звикли розуміти одна одну без слів, тож я розумію" — «за тією звичкою, яку ми маємо» — калька «avec cette habitude que nous avons de»; дієслово «звикли» природне %%
...
— Як це, навіть не маленьку філіжаночку? Я сама вам наллю, і ви вип'єте.
%% 2026-09-26T10:14:16 FAB: "Я зроблю її вам сама, і ви її вип'єте." → "Я сама вам наллю, і ви вип'єте." — «зробити філіжанку» — калька «vous la faire»; чай наливають (далі Марі й справді сама наливає) %%
...
І, охоплена раптовим нападом люб'язності, я йду на другий кінець столу, сама наливаю чай, у який кидаю той самий цукор, і сама несу його Бібі, який, геть здивований, висловлює бажання сховати цю філіжанку чаю в медальйон і пити її все життя.
%% 2026-09-26T10:14:16 FAB: "і пити її ціле своє життя" → "і пити її все життя" — зайвий присвійний займенник і «ціле життя» з «toute sa vie» %%
...
— Так, пам'ятаю, — кажу я *простим* тоном, якого навмисне тримаюся всю цю розмову.
%% 2026-09-26T10:14:16 FAB: "*простим* тоном, який удаю протягом усієї цієї розмови" → "*простим* тоном, якого навмисне тримаюся всю цю розмову" — «удавати тон» не сполучається; «j'affecte» — навмисне тримаюся %%
...
— Мені більше до вподоби другий, — каже він серйозно, дивлячись просто перед себе. Цей його вигляд так мені сподобався, що й досі я відчуваю легке зрушення серця.
%% 2026-09-26T10:14:16 FAB: "дивлячись просто себе" → "дивлячись просто перед себе" — випав прийменник: «regardant droit devant soi» — перед себе %%
...
— Ось що: ви думаєте про якусь даму, але слухайте уважно — думайте про щось чи про когось, про те, чим ви заклопотані; я, звісно, нічого знати не можу, я казатиму, а ви приміряйте, приміряйте.
%% 2026-09-26T10:14:16 FAB: "а ви прикладайте, прикладайте" → "а ви приміряйте, приміряйте" — «appliquez» у ворожінні — приміряти сказане до себе; «прикладайте» без додатка не має сенсу %%
%% 2026-08-14T13:17:00 FAB: "те, що вас займає" → "те, чим ви заклопотані" — «займати» в значенні «цікавити, посідати думки» — калька з російського «занимать»; українською думки саме заклопотані. %%
...
Гадаю навіть, що мої причепи не почули. Діна, якій я щойно прочитала ці рядки, не чула, але Бібі-Ольга напевно почула — вона-бо ковтає найменші слова, найменші жести, найменший подих цього чоловіка.
%% 2026-09-26T10:14:16 FAB: "але Бібі-Ольга мусила почути" → "але Бібі-Ольга напевно почула" — епістемічне «a dû» (напевно) передане модальним «мусила» — калька %%

%% 048.0182 %%
%% Enfin, ça m'est égal, puisqu'on m'a fait manquer mon tête-à-tête ! %%
Зрештою, мені байдуже, адже мені зіпсували тет-а-тет!
%% 2026-09-26T10:14:16 FAB: "адже мені зіпсували мій тет-а-тет" → "адже мені зіпсували тет-а-тет" — зайвий присвійний займенник із «mon tête-à-tête» %%
...
Ви ж розумієте, що я не гаятиму часу, розповідаючи все, та й, правду кажучи, не можу скласти щось ціле з цих невловних дрібок. Та й нічого надзвичайного не було.
%% 2026-09-26T10:14:16 FAB: "що я не бавитимуся розповіданням усього" → "що я не гаятиму часу, розповідаючи все" — віддієслівний іменник «розповіданням» — номінальна калька «m'amuser à raconter tout» %%
...
Анаграму з імені Бібі таки склали, але він і виду не подав, і якби я нічого не знала, ні про що б не здогадалася. Такий собі невинний вигляд — і питання, чому Амелі, а не Жозефіна. Справжня цукерочка!
%% 2026-09-26T10:14:16 FAB: "але він зберіг добру міну" → "але він і виду не подав" — «faire bonne contenance» — не показати збентеження; «зберегти добру міну» — калька (і повтор ідіоми з 048.0009 в іншому значенні) %%
...
Тут я перериваюся, щоб поговорити з Діною; розповідаю їй про поштовх.
%% 2026-09-26T10:14:16 FAB: "Тут я уриваю себе, щоб" → "Тут я перериваюся, щоб" — «уривати себе» — калька зворотного «je m'interromps» %%
...
— Та знаєш, цього не можна розповідати. Якщо все владнається, якщо я буду *розвінчана,* я розкажу про це всім, але якщо ні — це візьмуть за зле, скажуть, що це тому, що я закохана в того чоловіка. Слухай! Є дні, коли я переконана, що він закоханий у мене, а є інші, коли він на мене плює!
%% 2026-09-26T10:14:16 FAB: "це сприймуть на зле" → "це візьмуть за зле" — усталений вислів — «взяти/мати за зле»; «сприйняти на зле» не існує %%
...
Аж ніяк! Не робіть висновків! Я зовсім не нарікаю, я вже сказала, що це мене тішить. Я шкодую, але не *болісно,* тут усе миле й чарівне. Ніщо тут не крає серця.
%% 2026-09-26T10:14:16 FAB: "Не робіть своїх висновків!" → "Не робіть висновків!" — зайвий присвійний займенник із «vos conclusions» %%
%% 2026-08-14T13:19:00 FAB: "Немає жодних розривань серця" → "Ніщо тут не крає серця" — «розривання» у множині — незграбний віддієслівний іменник; «краяти серце» — жива українська ідіома для "déchirements". %%

%% 048.0202 %%
%% Je crois que j'étais jolie car il n'a pas cessé de me regarder, et un instant tellement, que ma tante l'a regardé. %%
Гадаю, я була гарна, бо він не переставав на мене дивитися, а якоїсь миті — так, що аж тітка глянула на нього.
%% 2026-09-26T10:14:16 FAB: "а одну мить так, що тітка глянула на нього" → "а якоїсь миті — так, що аж тітка глянула на нього" — «а одну мить так» — дослівне «un instant tellement»; часовий родовий і підсилювальне «аж» — природний лад %%
...
Щоб не знеохотити Пепіно, я кидаю йому кілька промовистих поглядів — і тепер можу не надто тримати його коло себе.
%% 2026-09-26T10:14:16 FAB: "завдяки яким вільна не надто тримати" → "— і тепер можу не надто тримати" — «завдяки яким вільна» — калька «moyennant lesquelles je suis libre» %%
%% 2026-08-14T13:21:00 FAB: "кидаю йому кілька оком" → "кидаю йому кілька промовистих поглядів" — попереднє було зіпсоване граматично («кілька оком»); "œillades" — саме промовисті, заохотливі погляди. %%
