...
[Замазано: Дехто каже, що] вже років тридцять чи сорок, як Жирарден... *нешкідливий,*[^91.42.1] інші ж кажуть, що маленька Жювізі, якій майже двадцять, — його дочка. Найкумедніше те, що вона разюче на нього схожа, він такий бридкий, а вона — наче маленька картина Ватто.
%% 2026-09-05T16:00:15 FAB: "безпечний" → "нешкідливий" (text and footnote) — "inoffensif" is 'harmless'; безпечний reads first as 'safe' or 'carefree' and blunts the euphemism the footnote explains %%

[^91.42.1]: «Нешкідливий» (*inoffensif*) — евфемізм на позначення статевого безсилля; у цьому контексті слово несе гірко-іронічний подвійний зміст.
...
Я вся вражена тим, що добре говорила, — я, котра має стільки чарівних речей напоготові, коли нікого немає, і не знаходить ані слова, коли треба; я високої думки про себе, і коли поводжуся як належить, то не можу стримати подиву й задоволення. Бідолашний Еміль лишається до пів на дванадцяту і що пізніша година, то дужче куняє.
%% 2026-09-05T16:00:16 FAB: "дрімає дедалі дужче, що пізніше стає" → "що пізніша година, то дужче куняє" — the trailing "що пізніше стає" was a calque of "à mesure que l'heure avance"; the що…то correlative is the native shape, and куняти is the exact word for an old man nodding off at table %%
