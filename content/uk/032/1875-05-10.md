...
О пів на одинадцяту я повертаюся заради Леклерка, з яким облаштовую свою лабораторію в колишній кухні флігеля.
%% 2026-08-14T11:05:00 FAB: "повертаюся до Леклерка" → "повертаюся заради Леклерка" — "je rentre pour Leclerc" означає, що Марі вертається додому на урок, а не йде до нього; попередній варіант суперечив кінцівці речення, де лабораторію влаштовують у її власному флігелі. %%
