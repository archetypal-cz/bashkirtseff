...
В головній залі є одна, яку я прийняла за Аталанту через пару сандалій, що, здається, вказують на головний смисл (але на написі — ім'я Психеї), — втім, однаково, Психея чи Аталанта, це чудова постать — і своєю красою, і природністю.
%% 2026-09-26T11:10:00 FAB: "(але напис містить ім'я Психеї)" → "(але на написі — ім'я Психеї)" — «l'inscription porte le nom» — «напис містить» канцелярська калька %%
...
%% 2026-08-15T18:30:00 FAB: "притиснутими й тікаючими лініями" → "густими й побіжними лініями" — «тікаючий» — активний дієприкметник, небажаний в українській %%
...
%% 2026-08-15T18:32:00 FAB: "розглядаючи їх, моя уява" → "коли я їх розглядаю, моя уява" — дієприслівник стосувався не того підмета %%
...
%% 2026-08-15T18:34:00 FAB: "осліплюючі" → "сліпучі" — активний дієприкметник на -юючий — русизм %%
...
Тепер треба було б ніби кінчиком пензля взяти надто яскраві кольори стародавніх полотен і перенести їх на блідість сучасних. Тоді й була б досконалість. Є ще зовсім новий жанр — писати плямами.[^064.279.1] Це груба помилка, хоча з її допомогою й досягають певного ефекту. У нових картинах конкретні предмети — меблі, будинки, церкви — не осмислені. Нехтують точністю декорацій і породжують якесь виродження ліній; розмивають занадто (можна розмивати й без розмивача), від чого постаті майже не контрастують і здаються такими самими мертвими, як предмети довкола них, — бо ті предмети позбавлені достатньої чіткості й ніби не стоять твердо й не завмерли на місці.
%% 2026-09-26T11:10:00 FAB: "Тоді б ми мали досконалість." → "Тоді й була б досконалість." — «on aurait la perfection» — калька з «avoir» %%
%% 2026-08-15T18:36:00 FAB: "як оточуючі їх предмети" → "як предмети довкола них" — «оточуючі» — русизм %%
%% 2026-08-15T18:36:00 FAB: "не закріплені й не нерухомі" → "не стоять твердо й не завмерли на місці" — подвійне заперечення робило фразу нечитною %%
...
%% 2026-08-15T18:38:00 FAB: "перекладених з кращих" → "перекладені з найкращих" — узгодження відмінка; «premiers écrivains» = найперші, найкращі %%

%% 064.0282 %%
%% [#Censored_1887](../../_original/_glossary/culture/literature/CENSORED_1887.md) %%
%% [#Reading](../../_original/_glossary/culture/themes/READING.md) %%
%% — Déjà ici une bibliothèque ! s'est écriée ma tante épouvantée. %%
— Уже й тут бібліотека! — скрикнула тітка в жаху.
%% 2026-09-26T11:10:00 FAB: "— Вже тут бібліотека!" → "— Уже й тут бібліотека!" — «Déjà ici une bibliothèque!» — тітка обурена, що бібліотека з'явилася навіть тут; частка «й» передає це природно %%
...
Чим більше читаю, тим більше хочу читати, і чим більше пізнаю, тим більше лишається пізнати. Я кажу це не для того, щоб наслідувати якогось античного мудреця. Я відчуваю те, що кажу.
%% 2026-09-26T11:10:00 FAB: "тим більше маю ще пізнати" → "тим більше лишається пізнати" — «plus j'ai de choses à savoir» — калька з «avoir» %%
...
Ось я — Фауст[^064.284.1]. Старовинний німецький письмовий стіл, за яким я сиджу, книги, зошити, сувої паперу...

[^064.284.1]: Фр. *en Faust* — наче Фауст із драми Ґете: вчений у своєму кабінеті, оточений книгами й змучений межами пізнання.
...
Надивившись на всю цю Античність, я сіла в екіпаж з найглибшою огидою до нашого мистецтва, нашої архітектури, наших мод. Якби хтось завдавав собі клопоту проаналізувати себе, виходячи з таких місць, то виявив би, що думає так само, як я. Навіщо хотіти ототожнювати себе з іншими?
%% 2026-09-26T11:10:00 FAB: "Після споглядання всієї цієї Античності я сіла" → "Надивившись на всю цю Античність, я сіла" — віддієслівний іменник «після споглядання» — калька з «après la contemplation» %%
%% 2026-08-15T18:40:00 FAB: "давав собі труд аналізувати" → "завдавав собі клопоту проаналізувати" — «prendre la peine» українською через «завдавати клопоту» %%
...
%% 2026-08-15T18:42:00 FAB: "вони незаймані заразою" → "їх іще не торкнулася зараза" — «vierges de» українською не передається прикметником з орудним %%
...
Ніщо не рівняється з ідеальною республікою, але республіка — мов горностай[^064.292.1]: найменша пляма її вбиває. Знайдіть же мені республіку без плям!

[^064.292.1]: «Мов горностай» — про горностая (ласку в зимовому хутрі) казали, що він радше загине, ніж заплямує свою білосніжну шубу; символ цілковитої чистоти, вжитий тут із навмисною іронією.
...
%% 2026-08-15T18:44:00 FAB: "з тих пір" → "відтоді" — калька з російської; в тому ж абзаці вже вживається «відтоді» %%
%% 2026-08-15T18:44:00 FAB: "давайте ж" → "поміркуймо" — «давайте» + дієслово — русизм; укр. має наказовий спосіб 1-ї особи множини %%
...
%% 2026-08-15T18:46:00 FAB: "управлятиме мало" → "правитиме мало" — про державця українською кажуть «правити» %%
...
Мене охоплює лють, коли я думаю, як негідно обійшовся зі мною Антонеллі.
%% 2026-09-26T11:10:00 FAB: "коли я думаю про негідний спосіб, у який обійшовся зі мною Антонеллі" → "коли я думаю, як негідно обійшовся зі мною Антонеллі" — «la façon indigne dont» — іменникова калька «спосіб, у який» %%
...
Так, усі ці *абстракції*, такі дорогоцінні для тієї, хто трохи чутлива й горда, були жахливо змарновані. Вони безцінні, бо не можна мати їх вдруге. І все це втрачено — кажу «втрачено», бо ця людина нічого не зрозуміла. Ось що мене мучить. Хіба ж він не поводився як негідник і хіба він не негідник? Мерзенний характер, — і я не розуміла... ні, розуміла, але завжди сподівалася змінити його, так хотілося помилитися, я чекала, що він стане людиною, а не жалюгідною, нікчемною твариною. І ось для такої істоти я заплямила себе! Господи милостивий!
%% 2026-09-26T11:10:00 FAB: "такі дорогоцінні для того, хто трохи чутливий і гордий" → "такі дорогоцінні для тієї, хто трохи чутлива й горда" — у французькому «fière» — жіночий рід: Марі говорить про себе %%
%% 2026-08-15T18:48:00 FAB: "Вони незмінні" → "Вони безцінні" — «inappréciables» = безцінні; попередній варіант змінював зміст %%
