...
%% 2026-06-06T19:15:00 RED: 059.0040 «не зверталаувагу» (missing space + form) → «не звертала уваги». Normalized «Ляредеї»→«Лардереї» (×19) to the form established in carnet 056. NOTE: 04-20 location=Paris faithfully mirrors source frontmatter (entry is actually the Rome races; source RSR value, not a translation error). %% Торлонія такий, яким я його і уявляла. Він не бажає ні чекати, ні коритися. Та вже сама борода каже про нього все. Він дотепний, може, трохи самозакоханий — але хто ж не такий у двадцять чотири роки? До того ж йому це личить.
