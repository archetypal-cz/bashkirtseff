...
%% 2026-09-26T10:59:02 FAB: "я дедалі більше заходила вперед" → "я заходила все далі й далі" — «m'engageais de plus en plus en avant» — калька; «заходити все далі» природне %%
...
[Навскоси: Уривок, який треба пам'ятати!]
%% 2026-09-26T10:59:02 FAB: "який треба пам'ятати I]" → "який треба пам'ятати!]" — «I» — артефакт транскрипції знака оклику в рукописі (у джерелі теж «I»); у перекладі відновлено «!» %%
