...
На прогулянці (блакитна сукня, втомлена). Мадемуазель Коліньон нехтує уроками, запізнюється тощо, і це завдає мені стільки болю, що навіть не можу описати. Час утікає, я втрачаю час, який ніколи не зможу надолужити; це мене так засмучує, що я геть нещасна.
