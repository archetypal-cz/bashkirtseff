...
Виходимо з Гітчкок пішки (блакитна сукня, чорний капелюшок, добре) — «вона така наївна», що заявила мені, ніби не слід щодня гуляти на набережній, ==because everybody will know you==[^12.47.1]. Я щиро з того посміялася.
%% 2026-08-14T10:20:00 FAB: "що сказала мені, що не слід" → "що заявила мені, ніби не слід" — знімає подвійне "що" в одному реченні; "ніби" ще й тримає іронічні лапки навколо "наївності" Гітчкок. %%
...
Мама сьогодні вперше виходить. Після обіду нічого не роблю — аби віддатися лінощам. О пів на дев'яту їдемо на вокзал зустрічати Говардів. Я, Діна, Поль і Гітчкок. Розкішне місячне сяйво. Ми занадто рано; відкриваємо ландо й заїжджаємо до Сакко за букетами. Поль — нікчема, тільки й уміє гримасувати та декламувати театральні сцени, але він кумедний, коли хочеться сміятися. Повертаємося на вокзал, навантажені двома букетами, що кололи в ніс, коли ми їх нюхали, — але це лише додавало загальних веселощів. Старий Плантус тут — він їхав із Говардами, але прибув на кілька годин раніше, розлучившись із ними десь по дорозі. Тридцять п'ять хвилин затримки — чекати, правду кажучи, дуже набридає; щоб розважитися, я розмовляла з Плантусом і нарешті попросила його назвати квіти, роздивитися їх і т. д. Це був простий букет троянд, тюльпанів, фіалок та геліотропів, але Плантус довго його розглядав; потім, мовляв, світла недостатньо — він попросив мене перейти до зали очікування, де, піднісши букет до лампи й надягнувши окуляри, довго дивився і нарешті почав низку латинських назв із надзвичайно потворною англійською вимовою. Весь час я зберігала кам'яну серйозність і вдавала, що мене дуже цікавлять назви, які він перелічує, і цей нікчемний букет. Але поки ми були так зайняті, оголосили потяг і зачинили зал першого класу, де ми були, — і ось ми вже біжимо до третього класу, прошмигнувши під носом у розгубленого службовця. Ось він нарешті, цей потяг — бачу в темряві його два ока, що швидко наближаються. Вдивляюся у вікна й нарешті знаходжу шукані об'єкти. Віллі, який мав вигляд дівчинки, стояв біля вікна, ==to watch us==[^12.48.1].
%% 2026-08-14T10:20:01 FAB: "Чудовий місячний вечір" → "Розкішне місячне сяйво" — «Un clair de lune délicieux» — це саме сяйво, а не вечір; образ повертає собі зоровість. %%
%% 2026-08-14T10:20:02 FAB: "що колються в ніс, коли їх нюхаєш" → "що кололи в ніс, коли ми їх нюхали" — узгоджує час із розповіддю довкола (додавало, був); теперішній узагальнений вибивався з оповіді. %%
%% 2026-08-14T10:20:03 FAB: "де ми знаходилися" → "де ми були" — "знаходитися" про людей — типова калька; українською люди просто "були". %%
%% 2026-08-14T10:20:04 FAB: "працівника" → "службовця" — вокзальний «employé» доби — службовець; "працівник" звучить із двадцятого століття. %%
%% 2026-08-14T10:20:05 FAB: "бажані об'єкти" → "шукані об'єкти" — «les objets cherchés»: вона їх видивляється, а не бажає; жарт із "об'єктами" від того лише виграє. %%
...
Піднімаюся у вагон, і поцілунки мене мало не розчавлюють. Вони всі такі раді нас бачити, такі щасливі, що, щиро кажучи, я не в змозі описати цю сцену.
%% 2026-08-14T10:20:06 FAB: "мало не зімнуть" → "мало не розчавлюють" — доконаний майбутній вибивався з теперішньої оповіді; «m'écrasent» — саме розчавлюють. %%
...
Поль бере валізи, я беру Елен і Ліз; сідаємо в нашу карету — я, Ліз, Елен, Діна, Гітчкок, а Поль на козлах — і їдемо до вілли Говардів, де вже приготовлено чай. Заходимо до їдальні, і, правду кажучи, я була голодна не менше за мандрівників. Неможливо, кажу, неможливо описати все, що було сказано, й порахувати всі поцілунки. Гадаю, що маю тут справжніх подруг.
%% 2026-08-14T10:20:07 FAB: "і, чесно, я була голодна" → "і, правду кажучи, я була голодна" — "чесно" як вставне слово — сучасна розмовна звичка; "правду кажучи" відповідає «vraiment» і добі. %%
...
Але час їхати. І з тисячею запевнень у ==friendship==[^12.53.1], любові й ніжності ми прощаємося. Цей запис пишу наступного дня, бо, знаючи, яка Елен гарна, не хотіла втомлюватися.
%% 2026-09-26T08:37:41 FAB: "Пишу цей щоденник наступного дня" → "Цей запис пишу наступного дня" — «Je fais ce journal» — тут ідеться про сьогоднішній запис, а «писати цей щоденник» українською означає вести весь щоденник. %%
%% 2026-08-14T10:20:08 FAB: "запевнень у коханні" → "запевнень у любові" — між дівчатами «amour» — це любов, а не закоханість; "кохання" тут вносить не той відтінок. %%

%% 2026-06-14T11:06:00 CON: APPROVED - Re-review pass. The Plantus bouquet-Latin set-piece and the station-arrival scene are rendered with momentum; «два ока» kept (Marie's image of the train's lamps). 1875 marginal annotation handled correctly. ~0.95. %%
