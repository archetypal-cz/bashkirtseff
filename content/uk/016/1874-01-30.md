...
%% 2026-02-17T12:00:00 OPS: "не рахується" → "не береться до уваги" — "не рахується" is a russicism (Russian "не считается"); Ukrainian: "не береться до уваги" or "не має значення" (sev A) %% Мати кокотку, як мав герцог, — це інша справа, але цей бідний Віттґенштайн цілком належить цій жінці.
