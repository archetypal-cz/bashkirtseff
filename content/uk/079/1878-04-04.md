...
%% 2026-08-15T11:41:00 FAB: "розмістив" → "розставив" — «placer» here is ranking in a competition, not seating. %%
%% 2026-08-15T11:41:30 FAB: "точне для малюнка" → "саме щодо малюнка" — «juste pour le dessin» limits the compliment to draughtsmanship; the old wording read as a property of the feeling itself. %%
%% 2026-08-15T11:42:00 FAB: "підпсований шиком" → "заплямований шиком" — «entaché» is a stain on the work's honour, which is how the atelier meant it. %%
%% 2026-08-15T11:42:30 FAB: "в результаті" → "а отже" — «в результате» transposed. %%
...
На щастя для мене, Робера-Флері не було — Лефевр і Буланже судили самі, — інакше б казали, що я 2-га завдяки протекції Робера-Флері.
%% 2026-09-26T11:59:01 FAB: "Робер-Флері був відсутній" → "Робера-Флері не було" — «était absent» — «був відсутній» is officialese; Ukrainian says someone «не було» %%
%% 2026-08-15T11:43:00 FAB: "протекції Робер-Флері" → "протекції Робера-Флері" — the name declines in Ukrainian, as it does elsewhere in the carnet. %%
