...
Принц Караджорджевич завітав до мами.
%% 2026-09-26T09:05:00 ED: "Карагеоргієвич" → "Караджорджевич" — Karageorgevitch: TM canon «Караджорджевич» (normalised 2026-06-14) %%
...
Одразу вся скутість зникає, і після обіду мама з капітаном фрегата сідають грати в карти, тоді як Поль, Діна й Марі (в близькому колі ми звемося по іменах) ідуть до мене і веселяться до пів на дванадцяту. Але цього вечора я втратила кілька ілюзій: я виявила, що Кассаньяк бреше, і що його повага, його шанування, його улюблений коник — словом, усе це лише привід, щоб не сказати засіб, дозволяти собі те, чого інший ніколи б не насмілився.
%% 2026-09-26T12:05:36 FAB: "його велика примха" → "його улюблений коник" — «son grand dada» is a hobby-horse; Ukrainian has the same image in «улюблений коник»; «примха» is a whim %%
Мої ноги — безперечно його, про це я більше не говорю, але руки — ні; і він насправді робить майже що завгодно, а сам тим часом повторює, що ми троє — три виняткові істоти, і що, крім того, залишаючись шанобливим, дивлячись на ногу, руку чи плече, він би оскверняв жінку думками, на які не має права, тощо, тощо.
%% 2026-09-26T12:05:56 FAB: "робить майже що завгодно, повторюючи при цьому, що" → "робить майже що завгодно, а сам тим часом повторює, що" — «tout en disant» — «при цьому» is on the Russianisms list, and the long participial clause hid the irony; a finite verb gives the contrast %%
%% 2026-09-26T12:06:16 FAB: "і що, зрештою, залишаючись" → "і що, крім того, залишаючись" — «en outre» = moreover; «зрештою» means "after all / finally" %%
%% 2026-08-15T14:50:00 FAB: "його велика примха нарешті" → "його велика примха — словом" — «enfin» here is the discourse marker that closes a list, not "at last". %%
...
Знаєте, я не вмію добре викласти це дивовижне кредо, але запевняю: все було дуже добре, — і оскільки я претендую на певну тонкість почуттів, я, мабуть, не маю потреби копирсатися в тому, що стоїть за словами, і шукати зло там, де його немає, але де дуже легко знайти його чимало, якщо задумаєшся над якимось словом
або відмовишся приймати речі відкрито такими, які вони є. Кассаньяк, який такий серйозний, як ви знаєте, сміявся весь вечір — як простий Мультедо. [Закреслені слова: Він нам] говорив про своє одруження і дав чесне слово, що нічого такого немає. Мені це приємно.
%% 2026-08-15T14:50:30 FAB: "немало" → "чимало" — «немало» follows the Russian form. %%
...
%% 2026-09-26T12:06:36 FAB: "найприродніше у світі" → "найприродніше на світі" — «le plus naturellement du monde» — Ukrainian «на світі» (family fix) %%
...
і спритно. Та байдуже — Кассаньяк зі своїми манерами може завести вас далеко так, що ви й не помітите; я йому саме це й сказала.
%% 2026-08-15T14:51:00 FAB: "може завести далеко, не помітивши цього" → "може завести вас далеко так, що ви й не помітите" — «sans qu'on s'en aperçoive» is the victim not noticing; the gerund had attached the blindness to Cassagnac. %%
