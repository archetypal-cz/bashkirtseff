...
Замість читати, я грала на гітарі, поки позувала. Річ у тім — бачите — що я вчу напам'ять.
%% 2026-08-15T14:35:00 FAB: "під час пози" → "поки позувала"; "Справа в тому" → "Річ у тім" — «дело в том» is the calque RED replaced twice elsewhere in the carnet. %%

%% 079.0532 %%
%% "On dit que l'on te marie. %%
«Кажуть, тебе видають заміж.
%% 2026-08-15T14:35:30 FAB: "оддають" → "видають" — the о- form is dialectal, and «видавати заміж» is the standard collocation. %%
...
Якби я була сентиментальнішою, або радше якби я не завжди вдавала безумну й несамовиту — можливо, я б виграла. Я здогадувалась про таємні думки мами й не помилялася. У мене не було таких думок, бо я заборонила їх собі — і мені це пішло на користь, і все було б більш-менш гаразд, якби сьогодні ввечері мене не підбурили проти долі, що несправедлива, злобна, глузлива й жорстока.
%% 2026-09-26T12:04:22 FAB: "Якби я вдавалася до почуттів," → "Якби я була сентиментальнішою," — «Si j'avais fait du sentiment» = had played the sentimental card; «вдаватися до почуттів» is not a Ukrainian phrase %%
%% 2026-09-26T12:04:42 FAB: "і добре вчинила" → "і мені це пішло на користь" — «je m'en suis bien trouvée» = it did me good; «добре вчинила» shifts it to a moral verdict %%
%% 2026-08-15T14:36:00 FAB: "задерикувата" → "глузлива" — «taquin» is the fate that teases, the same word rendered «глузування» on 17 April; «задерикуватий» means spoiling for a fight. %%
...
Але я не дозволяю собі спалахів — замикаюся в собі, затуляю очі й вуха й чекаю, поки гроза мине, кажучи собі: ти бачила й гірше, ще раз наберися мужності.
%% 2026-09-26T12:05:02 FAB: "збираюся всередині" → "замикаюся в собі" — «je me ramasse en dedans» — «збиратися всередині» is word for word; the Ukrainian idiom for withdrawing inward is «замикатися в собі» %%
%% 2026-08-15T14:36:30 FAB: "ще раз — мужності" → "ще раз наберися мужності" — «courage encore une fois» is an order to herself, and the elliptical version had no verb to carry it. %%
...
Я заборонила собі все, крім живопису, — а тут приходять і бентежать розум, душу, серце й усе інше. Моя дівчино, якщо тобі прикро — завжди думай ось що: це лише питання часу, з часом ти це забудеш, час заспокоює всі болі.
%% 2026-09-26T12:05:22 FAB: "якщо тобі зле" → "якщо тобі прикро" — «si tu es ennuyée» = vexed, troubled; «тобі зле» means feeling ill %%
%% 2026-09-26T12:05:42 FAB: "час змусить тебе це забути" → "з часом ти це забудеш" — «le temps te le fera oublier» — causative «змусить забути» calques «faire oublier» %%
Наберімося терпіння й довіримося Богу. Але завтра Поль де Кассаньяк має прийти на вечерю.
%% 2026-09-26T12:06:02 FAB: "Матимемо терпіння" → "Наберімося терпіння" — «Ayons patience» is an exhortation; «матимемо терпіння» is future indicative with French «avoir» %%
%% 2026-08-15T14:37:00 FAB: "час змусить забути" → "час змусить тебе це забути" — «le temps te le fera oublier»; both the person and the thing had dropped out. %%
...
Пів на одинадцяту — іду спати, щоб за звичкою за п'ять хвилин до восьмої бути в майстерні.
%% 2026-08-15T14:37:30 FAB: "о без п'яти восьма" → "за п'ять хвилин до восьмої" — «без пяти восемь» is the Russian way of telling the time. %%
