...
Боже, які ціни в Римі! Менш ніж за тисячу двісті франків на місяць ми нічого не можемо знайти. Та й то за тисячу двісті франків маєш лише необхідне, а про надмір годі й думати, хіба що за дві-три тисячі франків на місяць! Змилуйся, Боже! У готелі «Рим» я оглянула помешкання, таке велике й гарне, що в мене аж голова заболіла.
%% 2026-08-14T23:20:00 FAB: "Змилуйтеся!" → "Змилуйся, Боже!" — "Miséricorde!" is a cry to heaven at the Roman rents, not a plea to unnamed people %%
...
У Франції й уявлення не мають про цю пишноту, цю давню велич. Після багатьох марних пошуків ми врешті винаймаємо в тому самому готелі «Лондон», на другому поверсі, з балконом на площу Іспанії, помешкання з двох спалень, вітальні, передпокою, кімнати для занять і двох кімнат для слуг.
%% 2026-08-14T23:21:00 FAB: "цю величавість, цю давню велич" → "цю пишноту, цю давню велич" — French pairs two different words (grandeurs / vieille majesté); the Ukrainian repeated one root two words apart %%
...
Наш брат пожертвував собою, він зайшов по шию в твань і героїчно витяг твою негідну душу, яка вже браталася зі своїми товаришами по нещастю, отже, він витяг її і приніс до нашої блаженної оселі, де вона нині перебуває замкнена в дров'яній скрині Настоятеля.
...
Брати-ченці з Чимієзу.
1876, січень, Чимієз».
%% 2026-08-14T23:59:00 FAB: "Брати-монахи з Чимієзу" → "Брати-ченці з Чимієзу" — unified with the signature used from 052 onward %%
%% 2026-08-14T23:22:00 FAB: "Тіло, чию душу" → "Тіло, душу якого", and "той самий Коджері" → "означений Коджері" — inanimate possessor takes який, and "le dit Cogery" belongs to the same notarial idiom the letter keeps up with "означену душу", "означена міс Крузо" %%
%% 2026-08-14T23:22:00 FAB: "у дровітні Настоятеля" → "у дров'яній скрині Настоятеля" — "boîte à bois" is a box, and the joke needs the soul shut in something small, not stored in a woodshed %%

%% 051.0363 %%
%% [#Kernberger](../../_original/_glossary/culture/literature/KATHERINE_KERNBERGER.md) %%
%% Demain je l'envoie a ma tante qui la mettra a la poste. %%
Завтра я надішлю його тітці, а та відправить його поштою.
%% 2026-09-26T10:41:41 FAB: "Завтра я надішлю його тітці, яка відправить його поштою." → "Завтра я надішлю його тітці, а та відправить його поштою." — relative «яка» copied «qui la mettra à la poste»; the coordinating «а та» is the natural narrative link %%
