...
Ми пройшли Корсо, віа Ґреґоріана, форум Адріана, римський форум, бачили арки Септимія Севера, Костянтина, віа Аппіа, Колізей. Та все ще туманне, я не можу зорієнтуватися. Прогулянка на Пінчо чарівна, грала музика, але коли ми там були, людей було дуже мало. Статуї, статуї повсюди.
%% 2026-09-26T10:40:41 FAB: "але людей, коли ми там були, було дуже мало." → "але коли ми там були, людей було дуже мало." — the time clause wedged between subject and verb copied the French order («il y avait fort peu de monde, quand nous y étions») %%
...
Та воно й слушно, адже всі мої плани мають бути марними, а без цього шлюбу вони марними не були б. Хай йому грець! Від цієї розмови мені холонуть пальці. І є від чого, тисяча чортів і Робенсон на додачу! Оце вже й справді не щастить!
%% 2026-09-26T10:40:41 FAB: "Та й є з чого, тисяча чортів" → "І є від чого, тисяча чортів" — «il y a de quoi» — «є з чого» is a word-for-word tracing; «є від чого» is the Ukrainian idiom %%
%% 2026-08-14T22:50:00 FAB: "Оце вже й справді невдача!" → "Оце вже й справді не щастить!" — the line is a spoken punchline about "la guigne"; the abstract noun killed it %%
...
Це перебування в Римі здається мені чотиримісячним вигнанням, з незрівнянною радістю я думаю про повернення до Ніцци. Надто якщо Дивовижний не одружиться. О! він однаково на мене плюватиме. Карти провіщають мені багато доброго, але тільки інколи, випадково. Тож це не в рахунок.
%% 2026-09-26T10:40:41 FAB: "Тож воно не рахується." → "Тож це не в рахунок." — dummy «воно» is colloquial filler; «не в рахунок» is the native set phrase for «ça ne compte pas» %%
%% 2026-08-14T22:51:00 FAB: "мене зневажатиме" → "на мене плюватиме" — same "cracher dessus" image Marie repeats through this carnet, kept consistent with 28/29/31 Dec %%
...
Ах! Ніцца, Ніцца! Чи є на світі гарніше місто після Парижа? Париж і Ніцца, Ніцца і Париж. Франція, тільки Франція. Жити можна лише у Франції. Якщо мені вдасться ввійти в римське товариство, я полюблю Рим.
%% 2026-08-14T22:52:00 FAB: "Живуть лише у Франції." → "Жити можна лише у Франції." — "on ne vit qu'en France" is Marie's verdict on where life is worth living, not a remark about where people reside %%
...
Рим не справляє на мене враження Рима. Та чи справді це Рим?
%% 2026-09-26T10:40:41 FAB: "Та чи Рим це справді?" → "Та чи справді це Рим?" — inverted order traced «Est-ce bien Rome?»; Ukrainian puts the adverb before the predicate %%
...
Погано набувати звичок і ненавидіти зміни.
%% 2026-08-14T22:53:00 FAB: "звикати до звичок" → "набувати звичок" — the old wording tripped over its own root %%
...
Тоді про повернення до Ніцци — пиши пропало. Та хто змушує мене вірити в ці дурниці! Одне мамине слово! Як одним лише словом можна збурити мене всю. Сподіваюся, мої страхи безпідставні. Це було б надто бридко, це означало б, що мене кривдять з усіх боків.
%% 2026-08-14T22:54:00 FAB: "повернення до Ніцци пропаще" → "про повернення до Ніцци — пиши пропало" — "est flambé" is slangy resignation, and "пиши пропало" is its living Ukrainian counterpart %%
%% 2026-08-14T22:54:00 FAB: "збурити мене дощенту" → "збурити мене всю" — "дощенту" belongs to destroying things to the ground, not to being thrown into turmoil %%
