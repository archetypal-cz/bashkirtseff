...
Я нудьгую, мені хотілося б писати без кінця, коментувати весь свій щоденник, виправляти його, бо знаю, що там тисячі помилок, і не від мого невігластва, а саме від лінощів думати, від моєї надмірної поспішності. Я ніколи не знаю, що писатиму, і тим краще, немає нічого бридкішого за щоденник обдуманий, вилизаний[^53.302.1], надто коли ти не великий письменник. Та я люблю свої листи навіть більше за листи пані де Севіньє! «О ослице!» — вигукуєте ви. Я дозволяю вам кричати, і то лише тому, що не можу інакше. Її стиль такий манірний, такий вимучений під своєю позірною простотою, що мені аж недобре стає. А мій стиль не має стилю, я роблю помилки, але принаймні не чепурю свого писання.
%% 2026-09-26T10:41:53 FAB: "Тоді як мій стиль не має стилю," → "А мій стиль не має стилю," — "Tandis que" на початку речення - французька зв'язка; українською протиставлення несе "а" %%
%% 2026-09-26T10:41:53 FAB: "Я ніколи не знаю, що писатиму, і то й краще," → "Я ніколи не знаю, що писатиму, і тим краще," — "tant mieux" - усталене "і тим краще"; "і то й краще" - збита форма %%
%% 2026-08-14T12:32:00 FAB: "ще й люблю свої листи більше" → "люблю свої листи навіть більше" — "encore mieux" підсилює порівняння, а не додає ще один пункт %%
%% 2026-08-14T12:32:00 FAB: "Я даю вам вигукувати" → "Я дозволяю вам кричати" — "дати комусь вигукувати" - калька з "laisser crier" %%
...
Жодної змоги зустріти Сороку на вулиці, я бачила його лише в Опері, тобто загалом тричі.
%% 2026-08-14T12:34:00 FAB: "що становить три рази загалом" → "тобто загалом тричі" — канцелярське "становить" гальмувало легкий підрахунок Марі %%
...
Словом, того, що тут, ми називаємо просто Фредеріком; усе це до того, що колись я багато на нього дивилася, а тепер уже геть не дивлюся, ну геть, як сказав би Дивовижний, і що він починає прибирати пози.
%% 2026-08-14T12:36:00 FAB: "починає викаблучуватися" → "починає прибирати пози" — "викаблучуватися" - сучасний сленг, чужий регістрові щоденника; "poser" тут саме про манірні пози %%
...
%% 2026-08-14T12:38:00 FAB: NOTE: "фат" залишено, хоч українською воно означає радше чепуруна-самозакоханця, а "faquin" - хама низького коліна; виноска нижче саме так його й тлумачить. Заміна на "хам" вимагала б переписати й лему виноски, тож лишаю на розсуд RSR %%
...
Ми зустріли високого Дорію, що йшов Корсо пішки. У Римі він набагато елегантніший і кращий.
%% 2026-08-14T12:40:00 FAB: "Ми зустріли високого Дорію на Корсо пішки" → "…Дорію, що йшов Корсо пішки" — "пішки" тулилося до "ми"; насправді пішки був він %%
...
Сумно, коли немає на землі куточка, куди хотілося б поїхати, де тобі добре, де тебе люблять і де на тебе чекають. У Римі я нудьгую, у Ніцці теж нудьгую. Поїду до Росії. Справжній вічний жид.
%% 2026-09-26T10:41:53 FAB: "Достеменно вічний жид." → "Справжній вічний жид." — "Un vrai juif errant" - "справжній"; прислівник "достеменно" при іменнику звучить штучно %%
%% 2026-09-26T10:41:57 FAB: NOTE: у французькому "à Nice je ne m'ennuie pas non plus" - буквально "у Ніцці я теж не нудьгую", очевидна обмовка Марі (non plus вимагає сенсу "і там не краще"); переклад "у Ніцці теж нудьгую" передає задум, а не букву. Лишаю, але це на розсуд власника (cz теж згладжує) %%
...
Усе це щонайменше, та ще й зменшене вдвічі, бо вірити треба лише половині того, що кажуть. Це дуже гарний статок.
%% 2026-09-26T10:41:53 FAB: "Усе це за мінімумом і зменшене вдвічі," → "Усе це щонайменше, та ще й зменшене вдвічі," — "au minimum" - "за мінімумом" калька; "щонайменше" природне %%
...
Відколи Лола з матір'ю тут, ми майже завжди сміємося, вони жваві, усе їх бавить, тоді як мама вмерла душею. Кажуть, вона була дуже дотепна. Хвороби й жалі багато цього в неї відібрали, вона, однак, не дурна, але часто їй бракує такту, і вона робить прикрі промахи.
%% 2026-09-26T10:41:53 FAB: "тоді як мама морально вмерла." → "тоді як мама вмерла душею." — "morte moralement" - "морально вмерла" калька (і читається як моральний занепад); ідеться про згаслу душевну жвавість %%
%% 2026-08-14T12:42:00 FAB: "бракує такту, і вона робить нетактовності" → "бракує такту, і вона робить прикрі промахи" — знято тавтологію такт/нетактовність; "maladresses" - саме незграбні промахи %%
