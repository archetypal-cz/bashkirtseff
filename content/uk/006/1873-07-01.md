...
Уже кілька днів дідусь говорить мені про свій заповіт; я не вірила, що це серйозно; проте він добре зробив би, бо невідомо, що може статися. Ще вчора він попросив мене бути вільною сьогодні й купити паперу. З ранку я це зробила; після сніданку, побачивши, що дідусь мене не кличе, я сама йому сказала, що я вільна й усе готове.
...
Отже, ми пішли до його кімнати, і він мені диктує. Треба визнати, що це для мене велика честь. Де це бачено, щоб заповіт диктували чотирнадцятирічній дівчині? Це ж не дурниця, а правда — я не така, як усі. Серце в мене трохи калатало, коли я почала, бо це така серйозна й важлива річ — доля всіх його дітей. Він і сам був схвильований, це було чути з його голосу, а потім він почав швидко ходити по кімнаті. Він дає частину землі, будинок з бібліотекою й картинами (які він мені дарував десять разів, як і бібліотеку, але байдуже!) Жоржу; мамі теж маленький маєток гектарів у двісті, гадаю, й ліс, суміжний з його землею; решта розділиться за законом, тобто порівну між усіма братами. Заміжні дочки за законом нічого не отримують, хіба що це зазначено у заповіті. Він *розпорядився* всім, що сам набув, але землі, отримані у спадщину, не можна передавати заповітом — вони діляться за законом. Але дідусь видасть мамі векселі, і таким чином усе влаштується. Завжди є спосіб передати *спадщину*. Засоби завжди знайдуться. Тітці він поки що нічого не дає; каже, що їй не потрібно — з усім тим статком, який їй залишив чоловік. Зрештою, якщо процес обернеться проти неї, він дасть їй векселі на тридцять тисяч карбованців, так само як і мамі. Мені здається, це замало, адже статок сягає кількох мільйонів франків.
%% 2026-09-26T08:27:21 FAB: "Завжди знаходяться засоби." → "Засоби завжди знайдуться." — reflexive present copied 'on trouve toujours'; the Ukrainian saying is 'завжди знайдуться' %%
%% 2026-09-26T08:27:21 FAB: "я бачила це по його голосу" → "це було чути з його голосу" — 'по голосу' is a Russian-pattern government, and one hears agitation in a voice %%
%% 2026-09-26T08:27:21 FAB: "Серце моє трохи билося" → "Серце в мене трохи калатало" — 'mon cœur battait' of excitement is 'калатало'; 'билося' just says it was beating, and the postposed 'моє' is French-shaped %%
%% 2026-09-26T01:10:00 TR: papa → дідусь (ухвала 2026-09-26): тут «papa» — дід Марі по матері Степан Бабанін, а не батько Костянтин; див. виноску до 002.0225 і .claude/reports/papa-referent-2026-09-26.md %%
%% 2026-08-14T11:40:00 FAB: "Де ще давали записувати заповіт" → "Де це бачено, щоб заповіт диктували"; "але не має значення!" → "але байдуже!" — the rhetorical question needed the Ukrainian formula to sound like astonishment, and "qu'importe" is a shrug %%
...
Вдома зайшли до моєї кімнати, тобто Діна й Поль, бо решта в Монако. Ми почули гітару під вікном. Серенада! — вигукнула я, і всі троє на терасу. Але, на жаль, що це було? Це був кухонний хлопець! Він грав у саду для садівника, який своєю чергою взявся грати на скрипці, але так фальшиво, що ми втекли. Ми залишилися в моїй кімнаті до пів на одинадцяту, тоді я мусила виставити всіх. Я люблю, коли в мене збираються, коли до мене люблять приходити. Це потроху починається, і я сподіваюся, що з часом... Скрізь по кімнатах безлад, вони заставлені, тоді як моя — завжди охайна, впорядкована, світла, чиста, кокетливо облаштована — приємне видовище для ока. Природно, що в мене залишаються охочіше; до того ж у мене люди почуваються вільно, але я ніколи не даю їм перейти певну межу етикету, і це подобається. Я сподіваюся, що в *моєму домі* буде так само. Я нічого кращого не бажаю, ніж мати гостей з ранку до вечора. Головне, щоб кожному було приємно приходити.
%% 2026-09-26T08:27:21 FAB: "і потім я тримаю людей трохи вільно, але ніколи не даю" → "до того ж у мене люди почуваються вільно, але я ніколи не даю" — 'je tiens les gens un peu pas gênés' was rendered literally ('тримаю вільно'); the sense is that guests feel at ease with her %%
%% 2026-09-26T08:27:21 FAB: "У всіх кімнатах немає ладу" → "Скрізь по кімнатах безлад" — 'dans toutes les chambres il n'y a pas d'ordre' kept as a negated existential; Ukrainian names the state %%
%% 2026-09-26T08:27:21 FAB: "Я люблю, щоб збиралися в мене, щоб любили приходити до мене." → "Я люблю, коли в мене збираються, коли до мене люблять приходити." — 'j'aime qu'on…' calqued as 'люблю, щоб'; Ukrainian 'люблю, коли' (same fix as 29 June) %%
%% 2026-08-14T11:41:00 FAB: "Це трохи починається" → "Це потроху починається" — the sense is gradual, not partial %%
