...
%% 006.0229 %%
%% [#Kernberger](../../_original/_glossary/culture/literature/KATHERINE_KERNBERGER.md) %%
%% 2026-02-16T10:00:58 TR: "Gritsia" — Ґріця, зменшувальне від Григорій (Мілорадович). "Elisabeth Ivanovna" — його мати. %%
%% - Si vous voyez Gritsia et Elisabeth Ivanovna saluez-les. Cajolez Gritsia, soyez avec lui aimables, gentilles.* %%
— Якщо побачите Ґріцю й Єлизавету Іванівну, вітайте їх. Приголубте Ґріцю, будьте з ним привітні, люб'язні.*
%% 2026-08-14T13:00:00 FAB: "Лестіть Ґріці" → "Приголубте Ґріцю" — "cajoler" is coaxing warmth, not flattery %%
...
Це було сказано в множині, але я добре бачила, що це стосується мене. Зізнаюся, що, коли ми виїжджали з Росії (мені було одинадцять), цей Мілорадович залицявся до мене, але ми були дітьми.
%% 2026-09-26T08:30:14 FAB: "Зізнаюся, що, виїжджаючи з Росії (мені було одинадцять), цей Мілорадович" → "Зізнаюся, що, коли ми виїжджали з Росії (мені було одинадцять), цей Мілорадович" — dangling participle: 'виїжджаючи' attached the departure to Miloradovitch; French 'en partant' refers to Marie's family %%
%% 2026-09-26T08:30:14 FAB: "що це для мене." → "що це стосується мене." — 'c'est pour moi' means it was aimed at her; 'це для мене' reads as 'this is for me' (a gift) %%
...
Він мені жодної хвилини не подобався; навпаки, був мені трохи неприємний. Але мені так набридали, мама й тоді мала той самий план у голові, мені стільки про це говорили, що, спокушена його багатством, мені вистачило дурості написати на клаптику паперу, що хотіла б за нього вийти заміж, і ще кілька дурниць стосовно Берти, Бадена, Ремі тощо. Я написала це після першого року в Бадені. І ось одного дня цей папірець знайшли й почали мене дражнити. Я була в розпачі й молила Бога, щоб про це забули, і справді — мене залишили в спокої. Так ось, відтоді мама уявляє, що я була закохана в Мілорадовича, що це так поетично — від дитинства, вічне кохання і т. д. і т. д. І тепер вона вважає можливим, навіть певним, що це *удаване* кохання повернеться.
%% 2026-09-26T08:30:14 FAB: "І тепер вона вважає можливим, певним повернення цього *удаваного* кохання." → "І тепер вона вважає можливим, навіть певним, що це *удаване* кохання повернеться." — nominal 'повернення кохання' after 'вважає' followed French; the clause with a verb reads natively, and 'навіть' marks the escalation 'possible, sûr' %%
%% 2026-09-26T08:30:14 FAB: "я мала дурість написати" → "мені вистачило дурості написати" — 'j'ai eu la bêtise de' calqued as 'мала дурість'; the Ukrainian idiom is 'вистачило дурості' %%
%% 2026-08-14T13:01:00 FAB: "навпаки, трохи не подобався" → "навпаки, був мені трохи неприємний" — the repeated verb erased the "plaisait / déplaisait" contrast the whole sentence turns on %%
...
Увечері мені принесли мою білу сукню — вона саме така, як я хотіла; я дуже задоволена. Я вийшла — треба було дещо переробити, — і біля Лондон-Гаус ми всі побачили «Swiss Times». Пан Говард приїхав з Відня: ==«the cholera is raging»==[^06.236.1]. Ось тривожні новини, що перевертають усі мої плани. Гадаю, ми зачекаємо. Зрештою, завтра парламент обговорюватиме це питання — велике засідання.
%% 2026-08-14T13:02:00 FAB: "швейцарські газети" → "«Swiss Times»" — the French names the paper, and the quotation two sentences later comes from it %%

[^06.236.1]: В оригіналі англійською: «холера лютує».

%% 2026-06-14T11:30:00 CON: Para 006.0227/006.0230/006.0231 — нормалізовано «Милорадович» → «Мілорадович» (канонічна форма за TM і 006.0084-арки 06-18/07-10; и-форма «Милорадович» — варіант пізнішого українського-арку 065+, тут позаконтекстний). %%
%% 2026-06-14T11:30:00 CON: APPROVED — Марі рветься у Відень до «удаваного» дитячого нареченого; голос живий, іронія прозора. Перевірено проти оригіналу. %%
