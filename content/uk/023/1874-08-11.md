...
%% 2026-08-14T17:45:00 FAB: "чи іде дощ" → "чи йде дощ" — милозвучність після голосної %%
%% 2026-08-14T17:45:00 FAB: "цю людину, що приїхала" → "цього чоловіка, що приїхав" — «cet homme»; «людина» знеособлює саме там, де Марі здивовано вказує на конкретного чоловіка %%
...
%% 2026-08-14T17:45:00 FAB: "коли говорить" → "коли він говорить" — без підмета підрядне чіплялося до «голос» %%
...
%% 2026-08-14T17:45:00 FAB: "не скрізь є така їх кількість і такої якості" → "не всюди їх стільки й такої доброї якості" — канцелярське «така їх кількість» замінено живим зворотом; «bonne qualité» повернуто %%
...
%% 2026-08-14T17:45:00 FAB: "це пам'ятно" → "це варто запам'ятати" — «пам'ятно» як присудок українською не стоїть; «c'est mémorable» — гордовита позначка для себе %%
...
%% 2026-08-14T17:45:00 FAB: "(не тільки через це)" → "(не через це)" — «pas pour cela» — Марі заперечує, що причина в графі; «тільки» перевертало заперечення на визнання %%
%% 2026-08-14T17:45:00 FAB: "Мене вражає правда того, що" → "Мене вражає, скільки правди в тому, що" — знято канцелярську зв'язку %%
%% 2026-08-14T17:45:00 FAB: "найсолодші насолоди" → "найсолодші втіхи" — тавтологія «солодкі насолоди»; «plaisirs» = втіхи %%
...
%% 2026-08-14T17:45:00 FAB: "З трудом" → "Насилу" — «з трудом» — калька з російської %%
