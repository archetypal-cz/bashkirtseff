...
Ось він тут лише п'ять хвилин, а служба вже його вимагає; що ж до мами, то вона не може лишити мене саму, — це було гаразд, коли її зобов'язував до того процес, але отак поїхати й лишити мене за кордоном із тіткою, після вже таких довгих відлучок. А я, ви ж легко здогадуєтеся, не можу поїхати й поховати себе там.
%% 2026-09-05T10:40:42 FAB: "не можу їхати ховати себе там" → "не можу поїхати й поховати себе там" — aller m'enterrer là-bas — bury herself there; «їхати ховати себе» reads as going to hide %%
...
Словом... усі ці люди милі, але вони мені набридають.
%% 2026-09-05T10:41:19 FAB: "але вони мене нудять" → "але вони мені набридають" — ils m'ennuient — bore; «мене нудять» is nausea (fourth instance in this carnet) %%
