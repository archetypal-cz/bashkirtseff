...
%% 2026-05-30T00:00:00 RED: Виправлено полярність: фр. «je ne m'en fiche pas mal» тут — заперечення ідіоми «s'en ficher pas mal» (бути цілком байдужим), тобто «мені НЕ байдуже» (пор. наступне «але це завжди лестить»). Було «байдуже» — реверсувало зміст. %% Скільки всього я знайшла б написати, якби це був хтось інший, а не Плауден.
