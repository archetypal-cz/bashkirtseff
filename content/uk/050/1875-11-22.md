...
Ми були в моїх причепурювачів, а також у Біндера,[^50.0101.1] завтра вирішимо щодо екіпажів. Потім я заїхала до Берти, з якою досі листуюся, і провела в неї майже годину; ми обидві на якійсь дивній нозі — не дружимо, як дружать дівчата, ми просто знайомі.
%% 2026-08-14T22:16:00 FAB: "на якійсь дивній ноті" → "на якійсь дивній нозі" — Ukrainian measures relationships by the foot ("на короткій нозі"), which is the same image as "sur un drôle de pied"; "нота" pulled the phrase toward music and lost the idiom %%
...
«Звідси я роблю висновок, — пише мама, — що він небайдужий, бо якби був байдужий, то говорив би й розпитував, як усі інші. Ми ще бачили його на музиці, і він підійшов до екіпажа».
%% 2026-08-14T22:17:00 FAB: "як усі решта" → "як усі інші" — "решта" is a noun and cannot take "усі"; the corrected form is what Ukrainian says for "comme tous les autres" %%
...
Є ще й зустріч юнака з тією жінкою, де він хоче схилити її до примирення з чоловіком, де він показує їй, який скандал цей розрив накличе на її доньок.
%% 2026-09-26T10:16:17 FAB: "де він показує їй весь скандал, що вийде для її доньок із цього розриву." → "де він показує їй, який скандал цей розрив накличе на її доньок." — the noun chain "весь скандал, що вийде… із цього розриву" follows "tout le scandale qui résultera… de cette rupture" word for word; a verb clause is how Ukrainian says it %%
...
Відповідайте мені, пане, через рубрику «дрібної кореспонденції» у «Фігаро», якщо Ви, як і я, гадаєте, що тут є щось вартісне, — на ініціали T.P.L.

%% 050.0113 %%
%% — C'est méchant et absurde, dit ma tante. %%
— Це злостиво й безглуздо, — каже тітка.
%% 2026-08-14T22:19:00 FAB: "Це лихо й безглуздо" → "Це злостиво й безглуздо" — as a predicate "лихо" is first read as the noun (misfortune), so the aunt seemed to be lamenting rather than accusing; "méchant" is the charge of malice, which "злостиво" makes plainly. Applied to the same word in 050.0114 and 050.0122 %%
%% 2026-08-14T22:19:10 FAB: NOTE: "через рубрику «дрібної кореспонденції» у «Фігаро»" replaces bare "через дрібну кореспонденцію «Фігаро»" in 050.0112 — "рубрика" tells the reader this is a newspaper column, which is what Marie is asking Dumas to answer through %%
...
— Це більше, ніж злостиво, більше, ніж безглуздо, це підло, але що ж вдієш? Та й хіба не всі знають цю історію?
...
Те, що вона каже, — правда. Лише відколи Бібі з'явився у світі, старому дали спокій.
%% 2026-08-14T22:21:00 FAB: "старого дали спокій" → "старому дали спокій" — "дати спокій" governs the dative %%
...
— Так, лише відколи син почав виходити у світ, на нього стали дивитися прихильніше: син і його підносить, і себе змушує поважати.
%% 2026-08-14T22:22:00 FAB: "син піднімає його й змушує поважати" → "син і його підносить, і себе змушує поважати" — the French "le fils le fait et se fait respecter" has two objects, the father and the son himself; the old line dropped the reflexive and with it Barnola's point that Bibi earned his own standing %%
...
Цей лист — це безглуздо й злостиво, як каже тітка.
...
Тільки не вважайте мене за низьку й підлу істоту. Я в нестямі й не дуже усвідомлюю, що роблю. Зачекаю до завтра. Але я вже підла й низька тим, що в мене виник такий задум, що я не прогнала його тієї ж миті й що й досі вагаюся. А якщо й вагаюся, то лише тому, що не маю адреси Александра Дюма, не з іншої причини…
%% 2026-08-14T22:24:00 FAB: "підла й низька вже тим" → "підла й низька тим" — the doubled "вже" in one clause was a stumble in a sentence whose force depends on its steady accumulation of self-accusations %%

%% 050.0126 %%
%% J'écris aussi à ma mère: %%
Пишу також матері:
%% 2026-09-26T10:16:17 FAB: "Пишу також моїй матері:" → "Пишу також матері:" — the possessive copies "à ma mère"; Ukrainian drops it where the relation is obvious %%
...
Аби лиш вона не вбралася в біле — їй би це пасувало, вона ж така гостра!
%% 2026-08-14T22:25:00 FAB: "така гостряка" → "така гостра" — "гостряка" is not a Ukrainian word; the plain adjective also keeps this jab in the same words as the nickname «Гостра американка» two lines above, exactly as French repeats "pointue" %%
