...
— Так, але в мистецтві є речі, які треба знати. Не можна ж робити драпування (!!!!) як вийде, доведеться вибудовувати...
%% 2026-09-26T07:53:10 FAB: "(та ну!!)" → "(!!!!)" — the source's *(II!!)* is the transcription artefact for Marie's own «!!»; her bare exclamation marks were turned into invented words %%
...
Я не заперечую, бо інакше наговорила б йому дурниць. Але ж ой!.. Я не знайду своєї картини готовою в природі. Ну, дозвольте! Що це означає?
%% 2026-09-26T07:53:10 FAB: "це довело б мене до того, що я наговорила б" → "бо інакше наговорила б" — *cela me mènerait à* calque %%
...
Мені потрібен пейзаж приблизно такий, як той, про який я мрію, і він не складний.
%% 2026-09-26T07:53:10 FAB: "як той, що я мрію" → "як той, про який я мрію" — «мріяти» governs «про»; the relative calqued *que je rêve* %%
...
І мені потрібні дві жінки, яких я вже знайшла. Одна, головна, — дивовижна. А друга теж гарна. А потім? А потім треба десь облаштуватися на селі і ще потрібна гарна погода, щоб робити свої постаті. А пейзаж зроблю за етюдами, привезеними звідти.
%% 2026-09-26T07:53:10 FAB: "треба десь облаштуватися на селі і гарна погода" → "…і ще потрібна гарна погода" — the French zeugma (*il faut une installation… et du beau temps*) left a noun hanging after an infinitive %%
...
Приклад... ось уже шість чи сім років я більше не граю на фортепіано. Зовсім не граю, хіба кілька тактів мимохідь [Викреслено: і тричі на тиждень, якихось]; я місяцями не торкалася його, а тоді раптом грала по п'ять-шість годин на день раз на рік. За таких умов пальців наче й немає, тож я нічого не можу
%% 2026-09-26T07:53:10 FAB: "Та зовсім ні" → "Зовсім не граю" — *Mais là, plus du tout* intensifies "I don't play", «Та зовсім ні» read as a denial; "щоб раптом грати" → "а тоді раптом грала" — narrative *pour jouer tout à coup* is not a purpose clause %%
...
Втомлена молода селянка, що сидить край дороги і якій над вухом співають амури, сповнена безмежного почуття й безмежної ніжності...
%% 2026-09-26T07:53:10 FAB: "якій на вуха співають" → "якій над вухом співають" — *aux oreilles de laquelle* = in her ear; «на вуха» is not idiomatic %%
...
Учора ввечері й сьогодні по обіді ми ходимо на служби Страсного тижня в російській церкві.
%% 2026-09-26T07:53:10 FAB: "ми відбуваємо служби" → "ми ходимо на служби" — *assister* = attend; «відбувати» is to serve (a term, a duty) %%
