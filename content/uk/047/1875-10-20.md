...
Чого б я тільки не віддала, Боже мій, щоб мене цієї миті оточували! Він пішов, а я сама. Ох, який сказ! Я віддала б усі свої діаманти, аби ці останні два тижні мене оточували й за мною упадали.
%% 2026-09-26T10:11:59 FAB: "аби ці останні два тижні бути в щільному оточенні й мати безліч залицяльників." → "аби ці останні два тижні мене оточували й за мною упадали." — «бути в щільному оточенні» — дослівне être très entourée з військовим призвуком; дієслівна пара повторює хід першого речення («щоб мене… оточували») %%
...
Тієї ж миті, коли я виходжу наперед ложі, Бібі заходить у партер. Сапоженікови — у ложі бельетажу.
...
На Бібі я справила приязне враження, я це відчуваю. І спершу він не міг утриматися, щоб не дивитися на мене, як інші, але далі дуже уважно втупився в сцену, від чого скривився так, що зробився вельми бридкий.
%% 2026-09-26T10:11:59 FAB: "Враження, справлене на Бібі, було приязне, я це відчуваю." → "На Бібі я справила приязне враження, я це відчуваю." — дієприкметниковий зворот — калька L'impression produite sur %%
...
Приходить Біховець, приходить Барнола, приходить Коко, приходить Валіцький, приходить Фіулулу[^47.20.3]. Але Бібі була така поглинута Бібі, що ледве могла відповідати на те, що їй казали. Бібі здавалося, що вона схожа на дю Баррі[^47.20.4], — то було, мабуть, лише *таке собі відчуття.*
%% 2026-09-26T10:11:59 FAB: "Але Бібі була така заклопотана Бібі," → "Але Бібі була така поглинута Бібі," — «заклопотана» = стурбована; occupée de — поглинута кимось %%
...
Бібі під час кожного антракту відходила в глибину ложі, щоб у разі *візиту* не мусити щомиті повертати голову. Але настає останній акт, і цього разу Бібі сідає в крісло ліворуч, чудово освітлена сусіднім світильником, — Бібі сяяла.
%% 2026-09-26T10:11:59 FAB: "Бібі на кожному антракті відходила" → "Бібі під час кожного антракту відходила" — «на антракті» — калька à chaque entracte %%
...
Щойно піднімають завісу, ці двоє красенів підводяться й за хвилину вже в нас. Я приймаю їх з досконалою невимушеністю.
%% 2026-09-26T10:11:59 FAB: "Тієї миті, коли піднімають завісу, ці двоє" → "Щойно піднімають завісу, ці двоє" — калька Au moment où %%
...
%% 047.0294 %%
%% Il a l'air étrange; %%
Вигляд у нього дивний;
%% 2026-09-26T10:11:59 FAB: "Він має дивний вигляд;" → "Вигляд у нього дивний;" — «мати вигляд» — калька avoir l'air %%
...
— Як, це вже напевно, ви таки їдете?
%% 2026-09-26T10:11:59 FAB: "— Як, це напевно, отже, ви їдете?" → "— Як, це вже напевно, ви таки їдете?" — «отже» — дослівне donc у питанні; українською підсилення дає «таки» %%
...
На виході ми зустрічаємо Сапоженікових.
%% 2026-09-26T10:04:43 ED: "Сапожеников…" → "Сапоженіков…" ×1 — TM form «Сапоженіков-» (TM 035 onward; tree ~176:34) %%
...
— Ні, але колись ми ще матимемо справу одне з одним.
%% 2026-09-26T10:11:59 FAB: "— Ні, але колись ми матимемо одне з одним якусь справу." → "— Ні, але колись ми ще матимемо справу одне з одним." — дослівне avoir quelque chose à faire ensemble; сталий зворот «мати справу з кимось» (тобто зведемо рахунки) %%
