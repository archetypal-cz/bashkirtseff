...
Maman has invented a term like mine: I say "dust" and she calls all the men at Spa ==*zhuk*==[^1] [bumblebee]. Walitsky, every time a man passes, begins to buzz, ending with ==*zhuk!*==[^2] Often he stops a peasant woman and asks: ==*Little bumblebee, do you not know where there is a "zhuk"?*==[^3]
[^1]: Russian, *zhuk*: beetle or bug -- family code for eligible men.
[^2]: In Russian.
[^3]: Walitsky's question in Russian, comically addressed to local women.
...
[^4]: In Russian, addressed to the stranger.
