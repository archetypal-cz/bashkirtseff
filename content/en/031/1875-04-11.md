...
%% 2026-03-01T14:00:00 OPS: "There is nothing, *as I adore it*, like Anglican prayers" → "Nothing suits me so well as Anglican prayers" — the French "Rien de plus *comme j'aime*" is an intensifier; the previous rendering was a gallicism that read unnaturally in English (sev B) %%
I turned three times to the page where they pray for the Prince of Wales Albert-Edward, for the Queen, and for the nobility. I wonder no longer why they are so adorable — it is because so many prayers are offered for them.
