...
%% 2026-09-06T13:05:00 TR: Checked against the source entry: all four source paragraphs of 091.0582-0585 are translated here and nothing is missing. The only repair needed was in the embedded French of the first block, where stripping the footnote markers had closed up the space after "démenti,"; the space is restored. Footnote markers are not carried inside the embedded French anywhere in this carnet, so they were not reinstated. %%
%% 2026-09-06T13:06:00 TR: NOTE: this entry's paragraph IDs run one ahead of the source from the second block on, because the date heading was given its own block and took the first ID. The same shift affects 1881-05-10, 1881-05-11 and 1881-05-14; the gate reports it as an id-alignment warning. Not corrected here — it needs a single carnet-wide decision, not a per-entry patch. %%
