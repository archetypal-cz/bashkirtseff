...
%% 2026-09-06T13:15:00 TR: Checked against the source entry: all seven source paragraphs of 091.0575-0581 are translated here, and the embedded French matches the source word for word. Nothing was missing and nothing was changed. %%
%% 2026-09-06T13:16:00 TR: NOTE: the low coverage this entry scored in the integrity audit comes from its paragraph IDs, not from its text. The date heading was given its own block and took the first ID, so every block from the second on carries the ID of the block before it, and 091.0576 appears twice. The same shift affects 1881-05-10, 1881-05-12 and 1881-05-14; the gate reports it as an id-alignment warning. Not corrected here — it needs a single carnet-wide decision, not a per-entry patch. %%
