...
%% TR: "voudais" = Marie's spelling error for "voudrais"; rendered naturally in English %%
# Friday, 20 July 1877
...
%% TR: "Alexandre... Dumas" — Marie's ellipsis is deliberate, a pause before correcting herself from thinking of Larderei to the author %%
...
[^1]: *La Dame aux Perles* (1854) by Alexandre Dumas fils: a novel of ruinous passion.
...
%% TR: Preserved the dialectical structure and the rhetorical questions; "vœu incompris" = "misunderstood vow" %%
...
%% TR: "quelconque" = some random/any old (dismissive); "tout simple" = plain, unremarkable (the fan) %%
