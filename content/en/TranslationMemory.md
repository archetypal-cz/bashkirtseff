...
### Maman
- Translation: Maman (keep French)
- Context: Marie's mother. Use "Maman" throughout — this is how Marie refers to her.
- Notes: Do NOT translate to "Mother" or "Mama" — the French form is part of Marie's voice

### Duke of Hamilton
- Translation: Duke of Hamilton
- Context: Object of Marie's romantic interest in Nice
...
### Nice
- Translation: Nice
- Notes: Keep French name, well-known in English

### Promenade des Anglais
- Translation: Promenade des Anglais
- Notes: Keep French — it's a proper name, well-known

## Key Terms

### toilette
- Translation: dress / outfit / ensemble
- Context: 1870s usage = the complete outfit, NOT "toilet"
- Notes: "Change one's toilette" → "change one's dress"

### en amazone
- Translation: in a riding habit / sidesaddle
- Context: Women's riding costume with long skirt for sidesaddle
- Notes: NOT "like an Amazon"

### canaille
- Translation: scoundrel / rascal / rogue
- Context: Pejorative for lower classes; Marie uses it dramatically
- Notes: Context-dependent — sometimes keep French in italics

### promenade
- Translation: promenade / walk
- Context: Both the place and the social activity of walking
- Notes: Keep "promenade" when referring to the specific location

## Structural Markers

### Rayé / [Rayé]
- Translation: [Crossed out:]
- Context: Marie's self-censorship

### Dans la marge
- Translation: [In the margin:]
- Context: Marginal notes added later

### Page arrachée
- Translation: [Torn page:]
- Context: Missing pages

### En travers de la page
- Translation: [Written across the page:]
- Context: Physical diary marking

## Register & Crude Language

### crever (vulgar for "die")
- Translation: croak / kick the bucket
- Context: Deliberately crude — preserve the register
- Notes: Do NOT soften to "pass away" or "die"
...
- Translation: Grand-maman / Grand-papa (keep French)
- Context: Marie's maternal grandparents (Babanine family)
- Notes: Preserve French forms as Marie uses them

### Ma tante
- Translation: my aunt
- Context: Marie's maternal aunt (likely Sophie), younger than Maman
- Notes: Generic "my aunt" — Marie never names her

### le monde
- Translation: society (NOT "the world")
- Context: 1870s: high society, fashionable world
- Notes: "aller dans le monde" → "go into society"

### faire la cour
- Translation: to court / courted her
- Context: Romantic pursuit, standard 19th century
- Notes: Consistent across all entries

### déclassée
- Translation: *déclassée* (keep French, italicized)
- Context: Woman fallen in social standing — no direct English equivalent
- Notes: Explain in context or footnote on first use

### fille publique
- Translation: prostitute
- Context: Period euphemism, literally "public girl"
- Notes: Do NOT translate literally

### bains de mer
- Translation: sea baths
- Context: Fashionable seaside resorts (Crimea, etc.)
- Notes: NOT "swimming" — upper-class leisure activity

### femme du monde
- Translation: society woman
- Context: Woman of good standing in high society
- Notes: NOT "woman of the world"

### cavalier
- Translation: suitor / gentleman
- Context: Male dance partner or romantic interest
- Notes: NOT horseman in social contexts

### document humain
- Translation: *document humain* (keep French, italicized)
...
### verstes
- Translation: versts
- Context: Russian unit of distance (~1.07 km)
- Notes: Keep period unit, do NOT convert to kilometers
...
### à la musique
- Translation: at the concert
- Context: 1870s idiom for outdoor bandstand concerts on the Promenade
- Notes: NOT "at the music" — refers to specific social event

### cercle
- Translation: Cercle (keep French as proper name)
- Context: Exclusive social club (e.g., Cercle Masséna, Cercle de la Méditerranée)
- Notes: NOT "circle" — these are elite club venues

### la tribune
- Translation: the grandstand
- Context: Exclusive viewing area at races, balls, and events
- Notes: Reserved for high society

### voiture fermée
- Translation: closed carriage
- Context: Privacy-providing horse-drawn vehicle
- Notes: Contrasts with open carriage used for social display

### Tir aux pigeons
- Translation: pigeon shooting
- Context: Fashionable aristocratic sport at Monaco
- Notes: Live pigeon shooting competition

### commissaire aux courses
- Translation: race commissioner
- Context: Prestigious honorary role at horse races
- Notes: Held by prominent aristocrats

### fait des visites
- Translation: paid calls
- Context: Formal social visits — obligatory ritual
- Notes: NOT simply "visited"

### L'autre
- Translation: The other one
- Context: Marie's dismissive reference to Boreel (never named)
- Notes: Consistent dismissive register

### cette femme
- Translation: that woman
- Context: Dismissive term for Gioia (Duke's mistress)
- Notes: Implies illicit relationship; consistent throughout

### stout (gros)
- Translation: stout
- Context: 1870s usage for heavyset — not necessarily pejorative
- Notes: NOT "fat" in modern negative sense

### gentille
- Translation: pretty / pleasing
- Context: 1870s meaning: nice-looking, NOT merely "kind/nice"
- Notes: Modern French shifted to mean "kind"

### Bade
- Translation: Baden
- Context: Baden-Baden, fashionable German spa town
- Notes: Marie's short form

## People (from Carnet 001)

### Mlle Collignon
- Translation: Mlle Collignon
- Context: Marie's English governess
- Notes: Keep "Mlle" — period address for unmarried woman

### Gioia
- Translation: Gioia
- Context: The Duke of Hamilton's mistress (courtesan)
- Notes: Keep Italian name as-is

### Dina
- Translation: Dina
- Context: Marie's aunt (Dina Babanina)
- Notes: First-name basis shows close family relationship

### Boreel
- Translation: Boreel
- Context: Young man Marie was previously interested in, now eclipsed by the Duke
- Notes: Often referred to dismissively as "l'autre" (the other one)

## Social & Cultural Terms (from Carnet 002)

### homme bien
- Translation: man of good standing
- Context: 1870s: a man of quality, social position, character
- Notes: NOT "good man" — refers to social class and breeding

### matinée
- Translation: matinee
- Context: Afternoon social/musical gathering at a club or hotel
- Notes: NOT a morning event despite etymology — 1870s social usage

### soirée
- Translation: soirée (keep French)
- Context: Evening party or reception
...
- Context: Informal, slightly dismissive for someone's followers
- Notes: Marie uses this dismissively

### cantatrice
- Translation: opera singer / *cantatrice*
- Context: Female professional singer; Marie's aspiration
- Notes: Can keep in French italics when Marie uses it as a concept

### amour-propre
- Translation: pride / self-esteem
- Context: Key 19th c. psychological concept — vanity, self-regard
- Notes: NOT "self-love" — use "pride" in most contexts

### peine de cœur
- Translation: heartache
- Context: Romantic sorrow, period expression
- Notes: Simple "heartache" captures the register

### fiacre
- Translation: cab / hired cab
- Context: Horse-drawn cab for public hire
- Notes: NOT a private carriage — public conveyance

### fat (adjective)
- Translation: conceited / vain / self-satisfied
- Context: 1870s French: pompous, smug
- Notes: NEVER translate as English "fat" — completely different meaning

### magot
- Translation: grotesque creature
- Context: Strong insult — ugly or ridiculous person
- Notes: Marie uses this for Boreel in a moment of contempt

### se faire présenter
- Translation: to get oneself introduced
- Context: Formal social protocol — required before addressing someone
- Notes: Essential 19th c. social ritual

### cochon
- Translation: swine / pig
- Context: Vulgar insult, rare in Marie's writing
- Notes: Preserve the coarse register — she's quoting Boreel

### confetti (1870s)
- Translation: confetti (plaster pellets)
- Context: Hard plaster pellets thrown during Nice carnival
- Notes: NOT modern paper confetti — explain in footnote on first use

### domino
- Translation: domino
- Context: Full-length masquerade costume covering face and body
- Notes: Carnival-specific garment, not the game

### cocottes
- Translation: *cocottes* (keep French, italicized)
- Context: Courtesans, demimondaines
- Notes: No adequate English equivalent — keep French

### vêtement vigogne
- Translation: vicuna outfit
- Context: Garment made from vicuna wool — warm and expensive
- Notes: Marie mentions this outfit frequently

### Machenka
- Translation: Machenka
- Context: Russian diminutive of Marie/Maria — intimate family nickname
- Notes: Keep as-is, do not translate

## Social & Cultural Terms (from Carnet 003)

### coq du village
- Translation: cock of the walk
- Context: Man who struts about as the only eligible bachelor left
- Notes: "le coq du village" — idiomatic, preserve the barnyard metaphor

### chapeau bandit
- Translation: bandit hat
- Context: Wide-brimmed black hat fashionable in 1870s Nice
- Notes: Keep "bandit" — period fashion term

### cocotte abonnée
- Translation: kept mistress / regular courtesan
- Context: Woman in a semi-permanent arrangement with a wealthy man
- Notes: "abonnée" implies subscription/ongoing arrangement

### amitié-cochon
- Translation: vulgar familiarity
- Context: Crude intimacy, inappropriate closeness
- Notes: Preserve the coarse register — Marie is quoting social behavior she finds distasteful

### percale
- Translation: percale
- Context: Fine cotton fabric for summer dresses
- Notes: English cognate exists — keep as-is

### mousseline
- Translation: muslin
- Context: Lightweight cotton fabric for evening dresses
- Notes: Standard textile translation

### chemisette
- Translation: chemisette
- Context: Period women's undergarment / decorative bodice insert
- Notes: Keep French — no adequate English equivalent

### antédiluvien
- Translation: antediluvian
- Context: Comically outdated, old-fashioned
- Notes: Marie uses this dramatically for her own outfits

### Notre jour
- Translation: Our reception day
- Context: Fixed day of the week when a household received visitors
- Notes: NOT "our day" — specific 19th c. social institution

### faire mes dévotions
- Translation: making my devotions
- Context: Orthodox religious observances (Lent, Holy Week)
- Notes: Keep formal religious register

### Semaine Sainte
- Translation: Holy Week
- Context: Orthodox Holy Week — different dates from Catholic
- Notes: Marie's family follows Russian Orthodox calendar

### sang-froid
- Translation: composure / coolness
- Context: Marie uses this literally — "je ne puis le voir avec sang-froid"
- Notes: "I cannot look at it with composure" — NOT keep French here

### figure de cotillon
- Translation: cotillion figure
- Context: Choreographed sequence in a cotillion dance
- Notes: Cotillion is established English borrowing

### mauvais sujet
- Translation: rake / libertine
- Context: 1870s: man of dissolute habits
- Notes: NOT "bad subject" — idiomatic for a dissolute person

### bon enfant gâté
- Translation: spoiled good child
- Context: Marie's characterization of the Duke — indulged, carefree
- Notes: Preserve the oxymoron; she finds him lovably irresponsible

### robe en drap
- Translation: cloth dress
- Context: Woolen or heavy fabric dress for winter/outdoor wear
- Notes: "drap" = broadcloth — warm, practical fabric

### couaffée [sic]
- Translation: styled my hair (sic)
- Context: Marie's phonetic misspelling of "coiffée"
- Notes: Note the [sic] — Marie was 14 and writing fast

### prendre un bain de mer
- Translation: took a sea bath
- Context: Bathing in the Mediterranean — social/health activity
- Notes: Consistent with "bains de mer" term above
...
### Baron Finot
- Translation: Baron Finot
- Context: Previous object of Marie's affections, now eclipsed by the Duke
- Notes: Marie reflects on how her feelings have shifted

### Mlle de Galve
- Translation: Mademoiselle de Galve
- Context: Fashionable young woman whose style Marie envies and copies
- Notes: Full "Mademoiselle" in English text, "Galve" for shorthand

### Bensa
- Translation: Bensa
- Context: Family friend who gossips about the Duke and Gioia
- Notes: Marie transcribes his dialogue verbatim — theatrical

### Papa
- Translation: Papa (keep French)
- Context: Marie's father (absent but occasionally mentioned)
- Notes: Keep French form — Marie uses it consistently

%% 2026-02-13T16:00:00 TR: Initial English translation memory created %%
%% 2026-02-13T17:50:00 TR: Added terms from carnet 000 (preface) — family terms, social vocabulary, Russian terms %%
%% 2026-02-13T18:00:00 TR: Added terms from carnet 001 — social vocabulary, cultural terms, recurring people %%
...
### bon ami
- Translation: sweetheart / suitor
- Context: Servant's boyfriend/lover — Nice euphemism
- Notes: "bon ami de Marie" = the maid Marie's sweetheart

### péronelle
- Translation: scatterbrain / silly woman
- Context: Insult for a woman without principles
- Notes: Marie uses this for Markevitch

### vertus de laides
- Translation: virtues of ugly women
- Context: Bitter self-deprecation — qualities praised in women who lack beauty
- Notes: Marie's devastating phrase for grace, wit, goodness as consolation prizes

### la 3e section
- Translation: the Third Section
- Context: Tsarist secret police (political surveillance)
- Notes: Marie suspects a mysterious Russian visitor of being an agent

### bail
- Translation: lease
- Context: Rental contract for apartments/villas

### pourparlers
- Translation: negotiations
- Context: Extended discussions over property purchases

### petite république
- Translation: little republic
- Context: Marie's description of family decision-making — everyone has a voice
- Notes: "C'est rare de trouver une famille où il n'y ait pas de moi, c'est toujours nous"

### Crédit Foncier
- Translation: Crédit Foncier (keep French)
- Context: French mortgage bank providing long-term (50-year) financing
- Notes: Proper institution name

### imperméable
- Translation: waterproof / raincoat
- Context: Waterproof outer garment

### parure de boucles
- Translation: set of earrings
- Context: Matching jewelry set — gift from aunt

### chapeau en toile cirée
- Translation: oilcloth hat
- Context: Waterproof headwear

### batiste
- Translation: batiste
- Context: Fine thin linen fabric for summer dresses
- Notes: English cognate exists — keep as-is

### composta (Italian)
- Translation: composed / calm
- Context: Italian code-switch for emotional control
- Notes: Marie uses this to describe her cool farewell to Collignon

## People (from Carnet 005)

### Solominka / Markevitch
- Translation: Solominka (keep Russian diminutive)
- Context: Family companion — nickname means "little straw"
- Notes: Marie uses both "Solominka" and "Markevitch" interchangeably

### Manotte
- Translation: Manotte
- Context: Marie's piano teacher in Nice
- Notes: Keep as-is

### Pitou
- Translation: Pitou
- Context: The family monkey — a pet
- Notes: Keep as-is

### Prater
- Translation: Prater
- Context: The family dog — German name
- Notes: Keep as-is

### Moltchanoff
- Translation: Moltchanoff
- Context: Suspicious Russian stranger Marie fears is a spy or agent
- Notes: "C'est un homme dangereux!"

### Khalkionoff
- Translation: Khalkionoff
- Context: Young man staying with Mme Daniloff — "laid, simple"
- Notes: Claims art expertise; Marie dismisses him

## Prayer Register (from Carnet 005)

### Tu/Toi (addressing God)
- Translation: Thee / Thou
- Context: Marie's intimate address to God
- Notes: Capitalize when addressing deity. Marie shifts between Tu/Vous — preserve as Thee/You

### Très-haut
- Translation: Most High
- Context: Biblical epithet for God
- Notes: Consistent with Psalm language
