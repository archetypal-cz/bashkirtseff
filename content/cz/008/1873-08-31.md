...
Je pravda, že nebyla oblečená a měla slaměný klobouk na čele. Má skvrnu na levé tváři, která jí dodává trochu rošťácký a okouzlující vzhled. Vše, co mohu říci, je, že dnes není krásná.
...
%% 2026-02-15T15:00:00 GEM: "bohatou partii" → "skvělou partii" — "riche mariage" v kontextu = výhodný, skvělý sňatek (sev B) %%. A tímto tónem mi máma mluví o G. Miloradovičovi. Když říká, že si ho vezmu, ústa se jí roztáhnou — jako mně, když mluvím o vévodovi z Hamiltonu. Tak moc by si to přání přála.
...
%% 2026-02-15T15:00:00 GEM: "Hamilton je zadaný" → "Hamilton je již zadán" — "abonné" v kontextu = již zamluvený/zadaný (sev B) %%; když jsem řekla, že Miloradovič je příliš chudý — sedmdesát pět tisíc rublů příjmu — říká mi, že to je ohromné, a pak:
...
%% 2026-02-15T15:00:00 GEM: "bílém jako mušle budou obsluhovat dva černoši" → "bílém jako vnitřek mušle, budou obsluhovat dva mouřeníni" — "coquille blanche" = perleťový vnitřek mušle; "mouřeníni" je dobový ekvivalent "nègres" (sev B) %%.[^2] Tu ubohá kněžna říká, že její pokoj byl v růžovém saténu jako mušle a všechny závěsy byly z bruselské krajky. Ale její ctěný choť denně odnášel závěs, až nakonec pokoj vyklidil. Říká mi to jako příklad. Že by její muž byl náhodou tulák a bídník — nikdy.
...
Jediná myšlenka, jediný pohled vynaložený na jinou ženu dokazují, že milovanou ženu už nemilujeme. Neboť — opakuji — když jste zamilovaní, milujete ženu; můžete pomyslet na to, že budete milovat jinou? Ne. Nuže — k čemu žárlivost, k čemu výčitky? Trochu se pláče a člověk se musí utěšit jako při smrti a říci si, že je to konec a nic to nenapraví. Srdce plné jedné ženy — tam není místo pro druhou; ale začne-li se srdce vyprazdňovat, jiná do něj pomalu vstupuje, a jakmile tam vloží malíček, bývalá milenka nemá již nač doufat a musí se vzdát všech svých nároků[^4]
%% 2026-02-15T15:00:00 GEM: "==give up all her claims==" → "se vzdát všech svých nároků" — anglický code-switch přeložit do češtiny s poznámkou (sev B) %%. Je to silnější než muž — nemůže přinutit své srdce. Jsem filozofka, jak je vidět. Předpokládejme tedy, že vévoda je můj manžel; miluje mě — ale začne-li mě přestávat milovat, neřeknu nic, neboť bylo na mně, abych se dala milovat. Nemám-li dost kouzla, abych udržela jeho lásku — tím hůř pro mne. Není to chyba má ani jeho; je to přirozené a je třeba se sklonit před přírodou. Tak — to jsou mé myšlenky.
