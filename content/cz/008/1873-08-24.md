...
Srdce je kus živé tkáně[^6], který je spojen provázkem s mozkem
%% 2026-02-15T15:00:00 GEM: "kus ==flesh==, který komunikuje provázkem" → "kus živé tkáně, který je spojen provázkem" — "flesh" se má přeložit (ne ponechat jako code-switch); "komunikuje" je modernismus (sev B) %%, jenž zase dostává zprávy od očí nebo uší, a to vše způsobuje, že k vám mluví srdce. Protože se provázek zachvěje a srdce bije víc než obvykle a žene krev do tváře.
