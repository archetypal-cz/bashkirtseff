...
This document serves as a translation memory for the Marie Bashkirtseff diary translation project. It contains key terms, phrases, and concepts that should be translated consistently throughout the project.

## Purpose

The translation memory helps ensure:
- Consistency across all translated documents
- Preservation of the author's voice and style
- Proper handling of period-specific terminology
- Accurate translation of names, places, and cultural references

## How to Use

When translating, refer to this document for established translations of recurring terms. If you encounter a term not listed here that you believe should be added, please add it with the following format:

```
### Term (French)
- Translation (Czech): [translation]
- Context: [brief explanation of the term and its context]
- First appearance: [document ID where it first appears]
...
### Maman
- Translation (Czech): máma
- Context: Marie's mother, frequently mentioned throughout the diary
- First appearance: Early entries
- Notes: As specified in Style.cz.md, we use "máma" consistently

### Duke of Hamilton
- Translation (Czech): vévoda z Hamiltonu
- Context: A prominent figure in Nice society and object of Marie's romantic interest
- First appearance: January 1873 entries
- Notes: Maintain aristocratic title translation conventions

### Prince Gagarine
- Translation (Czech): kníže Gagarin
- Context: Notable figure in Nice's high society
- First appearance: January 1873
- Notes: Use Czech conventions for Russian aristocratic titles

## Places

### Nice
- Translation (Czech): Nice
- Context: French city where Marie spent time during the winter season
- First appearance: January 1873 entries
- Notes: Keep original spelling as it's a well-known location

### Poltava
- Translation (Czech): Poltava
- Context: City in eastern Ukraine where Marie Bashkirtseff was born
- First appearance: Background information
- Notes: Keep original spelling

## Concepts and Terms

### Carnet
- Translation (Czech): deník
- Context: The diary itself
- First appearance: Throughout
- Notes: Use "deník" consistently when referring to the diary

### Promenade
- Translation (Czech): promenáda
- Context: A key social space in Nice where the elite would gather
- First appearance: January 1873
- Notes: Use Czech equivalent rather than keeping French term

## Expressions and Phrases

### il n'y a point de plaisir sans peine
- Translation (Czech): není radosti bez trápení
- Context: Proverbial expression Marie uses when happy news has a downside
- First appearance: 006 (1873-07-09)

### grace au ciel
- Translation (Czech): zaplať Pánbůh
- Context: Exclamation of relief
- First appearance: 006 (1873-07-11)

### preux chevalier
- Translation (Czech): statečný rytíř
- Context: Ironic/literary epithet, often used mockingly
- First appearance: 006 (1873-07-12)

### Frappez et on vous ouvrira
- Translation (Czech): Tlučte a bude vám otevřeno
- Context: Biblical quote (Matthew 7:7), use standard Czech Bible translation
...
### on se mange
- Translation (Czech): požíráme se
- Context: "We devour each other" — family quarrels
- First appearance: 006 (1873-07-10)

### Rayé / [Rayé]
- Translation (Czech): [Škrtnuto:]
- Context: Marie's self-censorship marks
- First appearance: Various

### Dans la marge
- Translation (Czech): [Na okraji:]
- Context: Marginal notes added later
- First appearance: Various

### Page arrachée
- Translation (Czech): [Vytržená stránka:]
...
- Translation (Czech): chcípnout
- Context: Deliberately crude; Marie uses it in moments of emotional outburst
- First appearance: 006 (1873-07-12)
- Notes: Preserve the crude register — "chcípnout" matches the vulgarity of "crever"

### débauché, mauvais sujet, ivrogne, vaurien
- Translation (Czech): zhýralec, lump, opilec, ničema
- Context: Marie's angry tirade about Hamilton
- First appearance: 006 (1873-07-12)
...
### Bébé
- Translation (Czech): Bébé
- Context: Pet name for a young girl (Catherine's companion), keeps French spelling
- First appearance: 006 (1873-07-12)

### Walitsky
- Translation (Czech): Walitský
- Context: Family acquaintance, Czech -ský ending
- First appearance: 006 (1873-07-01)

## Places (Additional)

### Villa Baquis
- Translation (Czech): Villa Baquis
- Context: The family's residence in Nice
- First appearance: 006

### Monaco / Monte Carlo
- Translation (Czech): Monako / Monte Carlo
- Context: Excursion destination for gambling and sightseeing
- First appearance: 006 (1873-07-10)

## Musical Terms

### concerto en sol mineur
- Translation (Czech): koncert g moll
- Context: Musical key notation — Czech uses letter + "moll"/"dur"
- First appearance: 006 (1873-07-12)

### aller dans le mouvement
- Translation (Czech): dostat se do tempa
- Context: Musical term for getting up to speed/tempo
- First appearance: 006 (1873-07-12)

## Carnet 007 Terms

### gris/grise (tipsy)
- Translation (Czech): podnapilý/podnapilá
- Context: Slightly drunk from champagne — Marie uses it lightly
- First appearance: 007 (1873-08-06)

### sermon ambulant
- Translation (Czech): chodící kázání
- Context: Marie's epithet for Paul's moralizing
- First appearance: 007 (1873-07-23)

### blanc-bec
- Translation (Czech): zelenáč
- Context: "Greenhorn" — dismissive of young men
...
### cuir de Russie
- Translation (Czech): juchtová kůže
- Context: Russia leather — luxury material with birch-oil scent
- First appearance: 007 (1873-08-08)

### nielle
- Translation (Czech): niello
- Context: Russian silver inlay craft technique
- First appearance: 007 (1873-08-06)

### cravache éventail
- Translation (Czech): jezdecký bičík s vějířem
- Context: Riding crop with fan — novelty item at Vienna 1873
- First appearance: 007 (1873-08-06)

### en grand tralala
- Translation (Czech): v plné parádě
- Context: In full splendor/dressed to the nines
- First appearance: 007 (1873-07-26)

### sale fille
- Translation (Czech): špinavá holka
- Context: Vulgar insult — "dirty girl/prostitute"
- First appearance: 007 (1873-08-09)

### pour rire
- Translation (Czech): ze žertu
- Context: "For a laugh" — NOT "ze srandy" (too vulgar for Marie's register)
- First appearance: 007 (1873-07-30)
- Notes: RED flagged "ze srandy" as register violation

### fiakr
- Translation (Czech): fiakr
- Context: Horse-drawn cab; already in Czech usage from German/French
- First appearance: Early entries
...
### Moussinka
- Translation (Czech): Mousinka
- Context: Russian diminutive (Мусинка) — keep as-is
- First appearance: 007 (1873-07-26)

### Saxe (la)
- Translation (Czech): Saská
- Context: Demimondaine nicknamed after Saxony
- First appearance: 007 (1873-08-09)

### Wilt (Marie)
- Translation (Czech): Wiltová
...
- Context: **Ruling (maintainer, 2026-09-07; replaces the 2026-06-14 ban on the kníže-family forms).** Standard Czech distinguishes two titles that French collapses into *grand-duc / grande-duchesse*:
  - Russian *великий князь / великая княгиня* — any member of the Romanov house (grand-duc Constantin, Vladimir, Alexis, Nicolas, Serge; grande-duchesse Constantin, Marie Alexandrovna, Marie Nikolaïevna, Catherine, Olga de Russie, Anastasie; Dagmar as *grande-duchesse héritière*; generic "nos grands-ducs", "les grands-ducs à la messe", "épouser un grand-duc" in Marie's Russian frame) → **velkokníže / velkokněžna**. Also Kievan Rus rulers (kyjevský velkokníže Vladimír).
  - Western sovereign grand dukes (grand-duc de Bade, de Mecklembourg-Strelitz, de Toscane, de Hesse, de Luxembourg, de Saxe-Weimar, d'Oldenbourg…) and the fictional *Grande-Duchesse de Gérolstein* (Offenbach) → **velkovévoda / velkovévodkyně**; their states are *velkovévodství*.
  - Loose cases: Marie calls the Duke of Leuchtenberg (Nikolaj Maximilianovič, a Romanov by his mother, Prince Romanovsky) "grand-duc" — render velkokníže (the person is a Romanov; her usage is the Russian one).
- Declension velkokníže (vzor *kníže*): sg. velkokníže, velkoknížete (gen./ak.), velkoknížeti (dat./lok.), velkoknížetem (instr.); pl. velkoknížata, velkoknížat (gen.), velkoknížatům (dat.), velkoknížaty (instr.). **Plural takes neuter agreement**: dvě velkoknížata tam byla, naše velkoknížata se oženila, všechna velkoknížata. Possessive: velkoknížetův; relational adj.: velkoknížecí. Female velkokněžna: velkokněžny (gen.), velkokněžně (dat./lok.), velkokněžnu (ak.), velkokněžnou (instr.); pl. velkokněžny, gen. velkokněžen.
- Declension velkovévoda (vzor *předseda* / m. animate): sg. velkovévoda, velkovévody, velkovévodovi, velkovévodu, velkovévodou; pl. velkovévodové, velkovévodů, velkovévody. Female: velkovévodkyně, velkovévodkyni (dat./ak.), velkovévodkyň (gen. pl.). Masc.-animate agreement (velkovévodové přišli).
- Notes: Corpus normalised 2026-09-07 (73 occurrences in 41 files switched to the kníže-family forms; Baden ×2, Mecklenburg-Strelitz ×2 and Gérolstein ×2 kept as velkovévoda/velkovévodkyně). Older TR/FAB/RED/CON comments citing the 2026-06-14 ban are historical and were left untouched. First raised: con-102 (2026-06-13); FAB cz/089 (2026-09-05).
