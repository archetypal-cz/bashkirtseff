...
[^1]: *V originále anglicky:* "contempt" (opovržení, pohrdání)
[^2]: *V originále anglicky:* "contemptible creatures" (opovržení hodné tvory)
...
[^3]: *V originále anglicky:* "disappointed" (zklamaná)
[^4]: *V originále anglicky:* "Nice is a worthless place" (Nice je bezcenné místo)
