...
[^2]: *V originále anglicky:* "rivelets" (malé říčky, potoky)
[^3]: *V originále anglicky:* "removed" (odstranili, vzali pryč)
[^4]: *V originále anglicky:* "I began carefully" (začala jsem pečlivě)
[^5]: *V originále anglicky:* "for fear that she in walking shall see that somebody has been in the house" (ze strachu, že při chůzi uvidí, že tam někdo byl)
...
[^6]: *V originále anglicky:* "unfortunately" (bohužel)
