...
%% 2026-02-15T13:00:00 GEM: "vyprávívýsledky" → "vypráví úspěchy" — překlep (spojená slova) a "succès" = úspěchy %%, její toalety, kytice, šperky. A jsem celá rozhořčená a toužící zpívat na jevišti jako Pattiová.
...
%% 2026-02-15T15:00:00 GEM: "možná víc než všichni vy zůstat" → "zůstat možná víc než vy všichni" — nepřirozený slovosled (sev B) %%, ale vy jste řekli: Paul přijel pro nás: Musel jsem opravdu odejít.
