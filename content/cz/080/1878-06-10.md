...
%% 2026-08-13T17:30:00 FAB: "dal dost klidný pozdrav" → "pozdravil dost klidně" ("faire un salut" se česky převádí slovesem, opisná vazba tu Cassagnacovo odměřené kývnutí zdřevěněla); "v syrově bílém" → "v režně bílé" ("écru" je nebělená, přírodní bělost tkaniny, pro niž má čeština slovo "režný", kdežto "syrově bílá" žádný odstín neoznačuje); "byly bychom sedět" → "byly bychom usazeny" (tvar "bychom sedět" v češtině neexistuje). %%
...
%% 2026-08-13T17:31:00 FAB: "jevím se informovaná o všem" → "zdám se být o všem zpravena" — "paraître au courant" je působit zasvěceně; "jevit se" s holým přídavným jménem je knižní patvar a Marie tu právě sklízí obdiv, takže věta má klouzat. %%
...
%% 2026-08-13T17:32:00 FAB: "milá a moudrá" → "milá a způsobná" ("sage" tu neznamená moudrost, nýbrž způsobné chování mladé dámy v salonu — jinde v karnetu, kde jde o rozumnost, "moudrá" zůstává); "jet a vrátit se z Versailles" → "jet do Versailles a zpátky" (sloveso "jet" zůstalo bez cíle a věta se lámala uprostřed chlouby); "Také nejsem nespokojená" → "A tak nejsem nespokojená" ("aussi" na začátku věty je důsledkové "a tak", nikoli "také"). %%
...
%% 2026-08-13T17:33:00 FAB: "přes sluhu" → "po zřízenci" ("huissier" je sněmovní zřízenec ve stejnokroji, nikoli domácí sluha, a posílá se po někom); "při výkonu funkcí" → "při výkonu jeho funkce" (bez přivlastnění věta ztrácela, čí úřad se to vlastně vyrušuje — a právě ta parlamentní obřadnost je terčem Mariina vtipu). %%
...
%% 2026-08-13T17:34:00 FAB: "tato růžová perlíčka" → "tyto růžové perly" — zdrobnělina rozbíjela narážku na přísloví o perlách a sviních, na kterou Marie výslovně ukazuje ("navzdory přísloví") a kterou si v tomto karnetu už jednou pochvalovala (2. června, "Vždy perly a svině"). %%
...
%% 2026-08-13T17:35:00 FAB: "Gavini přijde nám říci" → "Gavini nám přijde říci" (příklonka patří na druhé místo); "Ach — to právě!" → "Ach — jakpak by ne!" — "Ah ! bien oui !" je jízlivé odbytí vlastní naděje ("to určitě!"), a doslovné "to právě" v češtině nic neznamená, přitom právě tímhle sarkasmem se celý výjev zvrhne v katastrofu s ujíždějícím vlakem. %%
...
%% 2026-08-13T17:36:00 FAB: "s náčelníkem" → "s vůdcem" (týž "chef" jako "Vůdce bandy" o dva odstavce výš — jednotné pojmenování drží ten ironický titul pohromadě); "na příštích 28. října" → "na 28. října" (množné "příštích" k datu nesedělo). %%
...
Co říkáte tomuto fiasku[^80.645.1]? Fiasko dost respektabilní — ano — ale pochopte — čím krásnější to bylo — tím odpornější je tento konec!

[^80.645.1]: Pozn. překl.: Fiasko (four) — divadelní slang pro propadák; Marie ho používá pro životní neúspěchy.
...
%% 2026-08-13T17:37:00 FAB: "Jaký triumf jsem promarnil!" → "promarnila!" — kritická chyba rodu: Marie je žena a hned následující věta ("jakou příležitost jsem promarnila") to má správně, takže si odstavec sám odporoval. "Ubohý Cassagnace" → "Bídný Cassagnace" — "misérable" je i zde nadávka, a "ubohý" ve chvíli, kdy mu Marie sděluje, že už není ani Vstupenka ani Ochrana, znělo shovívavě místo štiplavě. %%

%% 2026-06-11T21:20:00 CON: APPROVED - The Versailles session (the sweets-and-billet to Cassagnac "in the chamber", the duc de Padoue, the missed-train "four"/fiasco). Popaul kept; "four"→"fiasko" footnoted; "mon Empereur"→"můj Bože císaři". Score 0.91. %%
