...
%% 2026-06-13T16:19:00 LAN: TRAP: FALSE-FRIEND (source) — «ferons entrer» here = get Sautereau ADMITTED (into the vernissage) via their influence/connections, NOT "see him off" or literally "show him in" at a door. Render as "get him in / arrange his admission".  %%
...
%% 2026-08-13T23:20:00 TR: User report fix (KRR, missing_text): manuscript page-break split — added continuation ellipsis per EN convention (see en/099/1883-04-30.md 099.0251/099.0252); no text missing (verified against Kernberger). %%
...
%% 2026-08-13T23:20:00 TR: User report fix (KRR, missing_text): manuscript page-break split, continues 099.0251 — added leading continuation ellipsis; no text missing (verified against Kernberger). %%
...
Vysvětlil mi svou Ofélii. Čert! Není to umělec obyčejného talentu. Chápe to způsobem naprosto geniálním. Co mi o tom řekl, bylo skromné v nejhlubších záhybech duše. Je skutečně krásné takhle chápat umění, cítit jako on cítí. Nevidí ji jen jako šílenou – je to *nešťastnice lásky*[^099.254.1], je to nesmírné vystřízlivění ze snu, hořkost, zoufalství, konec všeho – nešťastnice lásky s nádechem šílenství. Je to nejdojemnější, nejsmutnější, nejzoufalejší postava…

[^099.254.1]: *Misérable d'amour*: zhruba „ubožačka zničená láskou" – vlastní výraz Julese Bastiena-Lepage pro jeho Ofélii, jak jej zaznamenala Marie.
...
%% 2026-06-14T11:15:00 CON: Para 099.0256 - odstraněno kognátní zdvojení „upřímné... upřímnosti" (sincérité franche) → „tak ryzí, nelíčené upřímnosti". %%
...
%% 2026-08-13T23:20:00 TR: User report fix (KRR, missing_text): manuscript page-break split — added continuation ellipsis per EN convention (see en/099/1883-04-30.md 099.0261/099.0262); no text missing (verified against Kernberger). %%
...
%% 2026-08-13T23:20:00 TR: User report fix (KRR, missing_text): manuscript page-break split, continues 099.0261 — added leading continuation ellipsis; no text missing (verified against Kernberger). %%
...
[^099.263.1]: *Mousmé*: japonská dívka; módní japonistický kostým, který zpopularizoval román Pierra Lotiho *Madame Chrysanthème* (1887), ačkoli tento typ byl v pařížské módě již dříve díky japonismu.
[^099.263.2]: *En Récamier*: oblečená jako Julie Récamierová (1777–1849), proslulá krasavice a salonní dáma, jejíž Davidův portrét ji zachycuje v bílých empírových šatech, ležící na pohovce – ikonický elegantní kostým.
...
Příliš mě rozmazlili – celkem tři roztomilé šílenkyně byly včera večer zklamány. Pokud jde o mě – díky Bohu je to skončeno, neboť vím, že za pět nebo šest let se stane členem Institutu[^099.283.1] a já budu v plném květu. Laskavě předejte tomuto budoucímu akademikovi tuto pozvánku, z níž nic nevyplyne – škoda, pro nás. Ostatně má naprosto pravdu, že se nevydává vyčerpávat po salonech – a od tohoto okamžiku ho považuji za dostatečně pozvaného, aby přišel sám, bez proseb.

[^099.283.1]: *Membre de l'Institut*: člen Institut de France, nejvyšší pocta ve francouzském intelektuálním životě, jenž sdružuje Francouzskou akademii a další čtyři akademie. „Nesmrtelný" v kulturní elitě.
