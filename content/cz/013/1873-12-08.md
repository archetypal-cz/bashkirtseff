...
[^1]: *V originále anglicky:* "The marriage of the duke of Hamilton"
...
[^2]: *V originále anglicky:* "HAMILTON.---The Glasgow Herald states that arrangements are now nearly completed for the befitting celebration of the marriage, on Wednesday next, of the Duke of Hamilton to Lady Mary Montagu, eldest daughter of the Duke and Duchess of Manchester"
...
[^3]: *V originále anglicky:* celý dlouhý citát popisující svatební přípravy
...
[^4]: *V originále anglicky:* další popis svatebních darů
...
[^5]: *V originále anglicky:* zmínka o diamantovém náramku za 2000 liber
...
[^6]: *V originále anglicky:* "a salute will be fired"
[^7]: *V originále anglicky:* "His Grace's employés"
