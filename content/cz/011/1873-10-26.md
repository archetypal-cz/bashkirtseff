...
%% 2026-06-13T11:00:23 RED: Splice repair (variant b): GEM comment split paragraph, text stranded after %%. Rejoined. Also: "nemluvě o zvěři, chtěli jsme zabít" → "nemluvě o zvěři — chtěli jsme zastřelit" (přirozenější); "Bylo mi těžké skákat" → "Těžko se mi skákalo" (přirozenější impersonal); "dobře zatlačený na hlavě" → "pevně nasazeným na hlavě" (přesnější). %%
