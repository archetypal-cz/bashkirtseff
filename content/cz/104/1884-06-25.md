...
%% 2026-06-14T12:30:00 RED: MEDIUM Para 104.0675 - "s zuřivostí" → "se zuřivostí"; "to byl žízeň" → "to byla žízeň" (žízeň je rod ženský). %%
...
%% TR: "T Pourquoi" — source transcription artifact; "T" likely reads as "1°" (first of two numbered points) based on para 0689 which has "2°" %%

%% 104.0689 %%
%% [#Reading](../../_original/_glossary/culture/themes/READING.md) %%
%% *2°* Le silence de Maupassant. %%
*2°* Mlčení Maupassantovo.
...
Stávalo se, že udělili medaile ženám, které si nechaly udělat obrazy, a jakmile je medaile udělena, je člověk v následujících letech automaticky přijat a může posílat ty nejploštější hrůzy. Loni dostala paní Dermontová (rozená Jules Bretonová) druhou medaili, protože obraz udělal její tatínek. A letos poslala hrůzu – ale je Hors Concours a v úrovni očí.
%% 2026-08-13T23:20:00 TR: User report fix class — "na cimaise" → "v úrovni očí" (per TM; term already established in 104.0043 footnote). %%
