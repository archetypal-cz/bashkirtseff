...
Inu, spokojená nejsem. Tony jako jindy shledává několik partií dobrými, ale celek mi komplimenty nevynese; dlouze mi vysvětluje, co je třeba udělat, a přidá pár tahů štětcem, které pak setřu. Co se týče Amélie, ta svůj obraz nevystavuje, není hotový a je ošklivý.
%% 2026-09-05T14:00:00 FAB: "a přidá pár tahů štětcem, které pak smažu" → "a přidá pár tahů štětcem, které pak setřu" — enlever o barvě = setřít; „smazat“ je dnes počítačové (srov. 091.0227) %%
...
V půl páté přichází Julian a nastává uvolnění! Hovoříme. Začala jsem v tři čtvrtě na osm, byla jsem unavená, a hlavně unavená z toho, že jsem si od Tonyho nevysloužila to „velmi dobré“. Bože, vím to dobře, je to veselé a živé, ale je v tom ohromný nedostatek řemesla.
%% 2026-09-05T14:00:07 FAB: "ale je v tom ohromný nedostatek umění" → "ale je v tom ohromný nedostatek řemesla" — manque de savoir = chybí znalost, řemeslná dovednost; „nedostatek umění“ říká, že obraz není umění %%
...
Byl by okouzlen, kdybych se toho zřekla, já také, ale co ti *ostatní?* Přátelé? Říkalo by se, že to, co jsem udělala, shledali profesoři příliš špatným, že jsem na obraz nestačila, zkrátka že jsem byla na Salonu odmítnuta.
%% 2026-09-05T14:00:14 FAB: "že jsem nebyla schopná obrazu" → "že jsem na obraz nestačila" — pas été capable d'un tableau — „schopná obrazu“ není česká vazba %%
...
Ale on říká, že je to tím, že jsem plátno přepracovala, že kdybych byla malovala tak, jak jsem začala, bylo by to dobré! A je tam ta akademická studie modelu, malého desetiletého chlapce — ne, kdybych to udělala jako týdenní studii, byla bych to seškrábala, tak je to banální, a hlavně obyčejně nakreslené, bez charakteru a naprosto mne nedůstojné, je to nejhorší část obrazu.
%% 2026-09-05T14:00:21 FAB: "A je tam ta akademická figura modela" → "A je tam ta akademická studie modelu" — l'Académie du modèle = akademie, tj. studie aktu podle modelu; „figura modela“ míchá dva pojmy %%
%% 2026-09-05T14:00:28 FAB: "a naprosto mě nedůstojné" → "a naprosto mne nedůstojné" — „nedůstojný“ se pojí s genitivem (nedůstojné mne), ne s akuzativem %%
...
Ach, je to mrzuté, ale co dělat?? Saint-Amand mě žádá o podrobnosti a chystá pořádnou propagaci ve „Sportu“ a v „Zápisníku jednoho světáka“[^91.287.1] podepsaném Jiskřičkou ve „Figaru“, který píše paní de Péronney (vikomt de Létorières) a k většině společenských novinek se inspiruje u Saint-Amanda.

[^91.287.1]: Pozn. překl.: „Carnet d'un mondain“ (Zápisník jednoho světáka) byla oblíbená společenská drbárenská rubrika listu Le Figaro vycházející pod pseudonymem „Etincelle“ (Jiskřička). Pisatelkou byla paní de Peyronney — vikomtesa de Létorières —, vedená Saint-Amandem, který jí dodával zprávy o Marii.
...
Je to má vina, pracuji už tři roky, je to vina toho lotra Juliana, měl předvídat, že na to nestačím... a to hovado vykřikuje: Ach, kdybych ho byl udělal! Ach, kdybyste ho byla udělala za rok!
%% 2026-09-05T14:00:35 FAB: "měl předvídat, že na to nemám sílu" → "měl předvídat, že na to nestačím" — je ne suis pas de force = nestačím na to (dovedností), ne fyzická síla %%
