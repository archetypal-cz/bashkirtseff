 ...
 * - Located at: src/_original/{carnet}/_summary.md (original)
 *              src/{lang}/{carnet}/_summary.md (translations)
 */
export class SummaryParser {
  ...
  parseFile(filePath: string): CarnetSummaryDocument {
    ...
    // Extract carnet from path (e.g., src/_original/001/_summary.md -> "001")
   ...
   * e.g., "src/_original/001/_summary.md" -> "001"
   */
