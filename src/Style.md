...
1. Place the original text in a Markdown comment: `[//]: # ( original text )`
2. Add a paragraph ID comment after the original: `[//]: # ( XX.YY )` where XX is the book number and YY is the paragraph number
